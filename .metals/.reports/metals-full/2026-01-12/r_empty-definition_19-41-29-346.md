error id: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles.java:_empty_/Closeables#close#
file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles.java
empty definition using pc, found symbol in pc: _empty_/Closeables#close#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 3931
uri: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles.java
text:
```scala
/*
