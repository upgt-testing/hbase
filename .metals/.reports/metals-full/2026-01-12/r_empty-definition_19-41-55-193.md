error id: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles_RestartInjected.java:_empty_/ColumnFamilyDescriptorBuilder#newBuilder#setBlocksize#
file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles_RestartInjected.java
empty definition using pc, found symbol in pc: _empty_/ColumnFamilyDescriptorBuilder#newBuilder#setBlocksize#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 3957
uri: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/regionserver/TestSplitWithBlockingFiles_RestartInjected.java
text:
```scala
/*
...
public class TestSplitWithBlockingFiles_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSplitWithBlockingFiles_RestartInjected.class);
  ...
  public static void setupCluster() throws Exception {
    ...
    TableDescriptor td = TableDescriptorBuilder.newBuilder(TABLE_NAME)
      .setColumnFamily(ColumnFamilyDescriptorBuilder.newBuilder(CF).setBloc@@ksize(1000).build())
      .build();
  ...
  public void testSplitIgnoreBlockingFiles() throws Exception {
    ...
    RestartFramework.at("after_split_policy_check")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_split_switch_enabled")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_split_submit")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_regions_verified")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
