error id: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/master/assignment/TestRollbackSCP_RestartInjected.java:_empty_/`<any>`#restart#withIndex#withMode#
file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/master/assignment/TestRollbackSCP_RestartInjected.java
empty definition using pc, found symbol in pc: _empty_/`<any>`#restart#withIndex#withMode#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 6041
uri: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/master/assignment/TestRollbackSCP_RestartInjected.java
text:
```scala
/*
...
public class TestRollbackSCP_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRollbackSCP_RestartInjected.class);
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    RestartFramework.at("after_balance")
        ...
        .restart("regionserver")
        .withIndex(0)
        .withMod@@e(RestartMode.GRACEFUL)
        .execute();
  ...
  public void testFailAndRollback() throws Exception {
    ...
    RestartFramework.at("after_get_rs_with_meta")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_exception")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
