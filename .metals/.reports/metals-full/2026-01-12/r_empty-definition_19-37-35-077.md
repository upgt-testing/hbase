error id: file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/master/assignment/TestRollbackSCP_RestartInjected.java:_empty_/RestartMode#
file://<WORKSPACE>/hbase-server/src/test/java/org/apache/hadoop/hbase/master/assignment/TestRollbackSCP_RestartInjected.java
empty definition using pc, found symbol in pc: _empty_/RestartMode#
...
public class TestRollbackSCP_RestartInjected {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    RestartFramework.at("after_balance")
        ...
        .restart("regionserver")
        .withIndex(0)
        .withMode(Res@@tartMode.GRACEFUL)
        .execute();
