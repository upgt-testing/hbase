...
public class TestCompactionState_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCompactionState_RestartInjected.class);
  ...
  private void compaction(final String tableName, final int flushes,
    ...
    try {
      ...
      RestartFramework.at("after_compaction_trigger")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
