...
public class TestTransitRegionStateProcedure_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestTransitRegionStateProcedure_RestartInjected.class);
  ...
  public void testRecoveryAndDoubleExecutionMove() throws Exception {
    ...
    RestartFramework.at("after_get_env")
    ...
    RestartFramework.at("after_get_region_and_seqnum")
      .on(UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_create_move_procedure")
      .on(UTIL.getMiniHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_recovery_and_double_execution")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testRecoveryAndDoubleExecutionReopen() throws Exception {
    ...
    RestartFramework.at("after_update_request_counts")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_reopen_procedure")
      .on(UTIL.getMiniHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testRecoveryAndDoubleExecutionUnassignAndAssign() throws Exception {
    ...
    RestartFramework.at("after_get_master_and_env")
      .on(UTIL.getMiniHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_unassign_procedure")
      .on(UTIL.getMiniHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_unassign_execution")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_assign_execution")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
