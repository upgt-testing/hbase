...
public class TestSerialReplicationChecker_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSerialReplicationChecker_RestartInjected.class);
  ...
  public void testLastRegionAndOpeningCanNotPush() throws IOException, ReplicationException {
    ...
    RestartFramework.at("after_add_state_barrier_second")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update_pushed_seqid")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCanPushUnder() throws IOException, ReplicationException {
    ...
    RestartFramework.at("after_add_state_barrier")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCanPushAfterMerge() throws IOException, ReplicationException {
    ...
    RestartFramework.at("after_add_parents")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update_pushed_seqid_regionB")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update_pushed_seqid_regionA")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCanPushAfterSplit() throws IOException, ReplicationException {
    ...
    RestartFramework.at("after_update_pushed_seqid_parent")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
