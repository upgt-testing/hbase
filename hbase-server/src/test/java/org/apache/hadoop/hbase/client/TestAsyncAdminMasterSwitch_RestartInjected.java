...
public class TestAsyncAdminMasterSwitch_RestartInjected extends TestAsyncAdminBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncAdminMasterSwitch_RestartInjected.class);
  ...
  public void testSwitch() throws IOException, InterruptedException {
    assertEquals(TEST_UTIL.getHBaseCluster().getRegionServerThreads().size(),
      admin.getClusterMetrics(EnumSet.of(ClusterMetrics.Option.SERVERS_NAME)).join()
        .getServersName().size());
    RestartFramework.at("after_initial_cluster_metrics")
