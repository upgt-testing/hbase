...
public class TestRSKilledWhenInitializing_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestRSKilledWhenInitializing_RestartInjected.class);
