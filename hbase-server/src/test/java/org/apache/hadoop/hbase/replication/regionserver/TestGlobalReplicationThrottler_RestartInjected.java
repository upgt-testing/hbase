...
public class TestGlobalReplicationThrottler_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestGlobalReplicationThrottler_RestartInjected.class);
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    RestartFramework.at("after_both_clusters_start")
        .on(utility1.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_add_replication_peers")
        .on(utility1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testQuota() throws IOException {
    ...
    RestartFramework.at("after_table_creation")
        .on(utility1.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    watcher.start();
    RestartFramework.at("after_watcher_thread_start")
        .on(utility1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
