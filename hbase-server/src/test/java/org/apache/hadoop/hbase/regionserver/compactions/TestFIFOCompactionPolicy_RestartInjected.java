...
public class TestFIFOCompactionPolicy_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFIFOCompactionPolicy_RestartInjected.class);
  ...
  public void testPurgeExpiredFiles() throws Exception {
    ...
    RestartFramework.at("after_major_compact_submit")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_major_compact_complete")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFIFOCompactionPolicyExpiredEmptyHFiles() throws Exception {
    ...
    RestartFramework.at("after_first_put_flush")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    TEST_UTIL.getAdmin().flush(tableName);
    RestartFramework.at("after_second_put_flush")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    TEST_UTIL.getAdmin().majorCompact(tableName);
    RestartFramework.at("after_first_major_compact_submit")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_major_compact_complete")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    table.put(put);
    TEST_UTIL.getAdmin().flush(tableName);
    RestartFramework.at("after_third_put_flush")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    TEST_UTIL.getAdmin().majorCompact(tableName);
    RestartFramework.at("after_second_major_compact_submit")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    Assert.assertEquals(0, sf.getReader().getEntries());
    RestartFramework.at("after_second_major_compact_complete")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
