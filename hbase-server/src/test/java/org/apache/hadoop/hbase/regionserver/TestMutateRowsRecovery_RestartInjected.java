...
public class TestMutateRowsRecovery_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMutateRowsRecovery_RestartInjected.class);
  ...
  public void MutateRowsAndCheckPostKill() throws IOException, InterruptedException {
    ...
    try {
      ...
      RestartFramework.at("after_row_mutation")
          .on(cluster)
      ...
      RestartFramework.at("after_rs_load_report")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
