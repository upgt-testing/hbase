...
public class TestRegionReplicasAreDistributed_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionReplicasAreDistributed_RestartInjected.class);
  ...
  public static void before() throws Exception {
    ...
    final TableName tableName =
      TableName.valueOf(TestRegionReplicasAreDistributed_RestartInjected.class.getSimpleName());
