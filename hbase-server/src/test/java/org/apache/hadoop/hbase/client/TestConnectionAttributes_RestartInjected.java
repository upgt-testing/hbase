...
public class TestConnectionAttributes_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestConnectionAttributes_RestartInjected.class);
  ...
  public static void setUp() throws Exception {
    ...
    Table table = TEST_UTIL.createTable(TABLE_NAME, new byte[][] { FAMILY }, 1,
      HConstants.DEFAULT_BLOCKSIZE, TestConnectionAttributes_RestartInjected.AttributesCoprocessor.class.getName());
    table.close();
  ...
  public void testConnectionHeaderOverwrittenAttributesRemain() throws IOException {
    ...
    try (Connection conn = ConnectionFactory.createConnection(conf, null,
      ...
      RestartFramework.at("after_connection_create")
          .on(TEST_UTIL.getMiniHBaseCluster())
