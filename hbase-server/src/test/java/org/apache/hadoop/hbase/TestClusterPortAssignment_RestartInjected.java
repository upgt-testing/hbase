...
public class TestClusterPortAssignment_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClusterPortAssignment_RestartInjected.class);
  ...
  public void testClusterPortAssignment() throws Exception {
    ...
    do {
      ...
      try {
        ...
        RestartFramework.at("after_master_port_verification")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_rs_port_verification")
          .on(cluster)
