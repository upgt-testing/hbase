...
public class CloneSnapshotFromClientCloneLinksAfterDeleteTestBase_RestartInjected
  ...
  public void testCloneLinksAfterDelete() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_delete_original")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_third_clone")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
