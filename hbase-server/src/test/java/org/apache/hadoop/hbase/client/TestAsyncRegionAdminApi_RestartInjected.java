...
public class TestAsyncRegionAdminApi_RestartInjected extends TestAsyncAdminBase {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncRegionAdminApi_RestartInjected.class);
  ...
  public void testAssignRegionAndUnassignRegion() throws Exception {
    ...
    RestartFramework.at("after_region_assigned")
        .on(TEST_UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_unassign")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetRegionByStateOfTable() throws Exception {
    ...
    RestartFramework.at("after_create_multi_region_table")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetOnlineRegions() throws Exception {
    ...
    RestartFramework.at("after_table_create_get_online")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFlushTableAndRegion() throws Exception {
    ...
    RestartFramework.at("after_table_flush")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCompactMob() throws Exception {
    ...
    RestartFramework.at("after_create_mob_table")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCompactRegionServer() throws Exception {
    ...
    RestartFramework.at("after_minor_compaction")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCompactionSwitchStates() throws Exception {
    ...
    createTableWithDefaultConf(tableName, null, families);
    loadData(tableName, families, 3000, 8);
    RestartFramework.at("after_load_data_compaction_switch")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCompact() throws Exception {
    ...
    RestartFramework.at("after_first_compaction_test")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonExistentTableCompaction() {
    ...
    RestartFramework.at("between_compaction_tests")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
