...
public class TestChangeStoreFileTracker_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestChangeStoreFileTracker_RestartInjected.class);
  ...
  public void testModifyError9() throws IOException {
    TableDescriptor td = TableDescriptorBuilder.newBuilder(tableName.getTableName())
      .setColumnFamily(ColumnFamilyDescriptorBuilder.of("family")).build();
    UTIL.getAdmin().createTable(td);
    RestartFramework.at("after_table_create_error9")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    TableDescriptor newTd = TableDescriptorBuilder.newBuilder(td)
      ...
      .build();
    UTIL.getAdmin().modifyTable(newTd);
    RestartFramework.at("after_modify_while_disabled")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testModify() throws IOException {
    ...
    TableDescriptor newTd = TableDescriptorBuilder.newBuilder(td)
      ...
      .build();
    UTIL.getAdmin().modifyTable(newTd);
    RestartFramework.at("after_modify_to_migration")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_modify_to_file")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
