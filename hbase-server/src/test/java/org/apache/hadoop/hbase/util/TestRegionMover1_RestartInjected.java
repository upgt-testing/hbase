...
public class TestRegionMover1_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionMover1_RestartInjected.class);
  ...
  public void testWithAck() throws Exception {
    ...
    try (RegionMover rm = rmBuilder.build()) {
      ...
      rm.unload();
      RestartFramework.at("after_unload")
          .on(cluster)
          .restart("master")
          .withIndex(0)
  ...
  public void testExclude() throws Exception {
    ...
    try (RegionMover rm = rmBuilder.build()) {
      rm.unload();
      RestartFramework.at("after_unload_with_exclude")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDesignatedFile() throws Exception {
    ...
    try (RegionMover rm = rmBuilder.build()) {
      ...
      rm.unload();
      RestartFramework.at("after_unload_with_designated")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testLoadMetaRegion() throws Exception {
    ...
    try (RegionMover rm =
      ...
      rm.unload();
      RestartFramework.at("after_meta_unload")
      ...
      rm.load();
      RestartFramework.at("after_meta_load")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDecomServerExclusionWithAck() throws Exception {
    ...
    RestartFramework.at("after_server_decom")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try (RegionMover regionMover = rmBuilder.build()) {
      ...
      RestartFramework.at("after_unload_decom_excluded")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
