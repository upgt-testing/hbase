...
public class TestRegionServerScan_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionServerScan_RestartInjected.class);
  ...
  public void testScannWhenRpcCallContextNull() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_scan_setup")
        .on(TEST_UTIL.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_scan_result")
        .on(TEST_UTIL.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_scan_result")
        .on(TEST_UTIL.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
