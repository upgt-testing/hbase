...
public class TestAsyncTableGetMultiThreaded_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableGetMultiThreaded_RestartInjected.class);
  ...
  protected static void setUp(MemoryCompactionPolicy memoryCompaction) throws Exception {
    ...
    TABLE.putAll(
      ...
      .get();
    RestartFramework.at("after_table_create_and_data_load")
