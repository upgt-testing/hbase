...
public class TestRegionReplicaWaitForPrimaryFlushConf_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionReplicaWaitForPrimaryFlushConf_RestartInjected.class);
  ...
  public void testSecondaryReplicaReadEnabled() throws Exception {
    ...
    RestartFramework.at("after_region_collection")
        .on(HTU.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_executor_verification")
        .on(HTU.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_enabled_verification")
        .on(HTU.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
