...
public class TestRecreateCluster_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRecreateCluster_RestartInjected.class);
  ...
  private void validateRecreateClusterWithUserTableEnabled(boolean cleanupWALs,
    ...
    RestartFramework.at("after_prepare_data_enabled")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void restartHBaseCluster(boolean cleanUpWALs, boolean cleanUpZnodes) throws Exception {
    ...
    RestartFramework.at("after_procedures_done")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
