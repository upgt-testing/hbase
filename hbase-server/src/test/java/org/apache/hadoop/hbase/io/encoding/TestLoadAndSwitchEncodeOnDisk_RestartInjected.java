...
public class TestLoadAndSwitchEncodeOnDisk_RestartInjected extends TestMiniClusterLoadSequential {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestLoadAndSwitchEncodeOnDisk_RestartInjected.class);
  ...
  public TestLoadAndSwitchEncodeOnDisk_RestartInjected() {
  ...
  public void loadTest() throws Exception {
    ...
    RestartFramework.at("after_modify_column")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
