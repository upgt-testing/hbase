...
public class TestSerialReplicationChecker_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestSerialReplicationChecker_RestartInjected.class);
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        RestartFramework.at("after_wal_addition").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testLastRegionAndOpeningCanNotPush() throws IOException, ReplicationException {
        RegionInfo region = RegionInfoBuilder.newBuilder(tableName).build();
        RestartFramework.at("after_add_state_barrier_first").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        addStateAndBarrier(region, RegionState.State.OPEN, 10);
        RestartFramework.at("after_add_state_barrier_second").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_update_pushed_seqid").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCanPushUnder() throws IOException, ReplicationException {
        ...
        RestartFramework.at("after_update_pushed_seqid").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_add_state_barrier").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCanPushAfterMerge() throws IOException, ReplicationException {
        ...
        RestartFramework.at("after_update_pushed_seqid_regionA").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_parents").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_update_pushed_seqid_regionB").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCanPushAfterSplit() throws IOException, ReplicationException {
        ...
        RestartFramework.at("after_update_pushed_seqid_parent").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
