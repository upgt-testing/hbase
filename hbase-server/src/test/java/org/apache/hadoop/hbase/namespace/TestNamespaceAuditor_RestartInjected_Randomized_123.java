...
public class TestNamespaceAuditor_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestNamespaceAuditor_RestartInjected.class);
    ...
    public void testTableOperations() throws Exception {
        RestartFramework.at("after_first_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_table_create").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testValidQuotas() throws Exception {
        ...
        RestartFramework.at("after_get_filesystem").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
            ADMIN.createNamespace(nspDesc);
        } catch (Exception exp) {
    ...
    public void testDeleteTable() throws Exception {
        ...
        HColumnDescriptor fam1 = new HColumnDescriptor("fam1");
        RestartFramework.at("after_first_table_delete").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_tables_create").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRegionMerge() throws Exception {
        ...
        RestartFramework.at("after_region_merge").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ADMIN.splitRegionAsync(hris.get(1).getRegionName(), Bytes.toBytes("6")).get(10, TimeUnit.SECONDS);
            fail();
   ...
   */
    ...
    public void testRecreateTableWithSameNameAfterFirstTimeFailure() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_failed_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_successful_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStatePreserve() throws Exception {
        ...
        RestartFramework.at("after_table_delete").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private void deleteTable(final TableName tableName) throws Exception {
        ...
        MasterSyncObserver observer = UTIL.getHBaseCluster().getMaster().getMasterCoprocessorHost().findCoprocessor(MasterSyncObserver.class);
    ...
    public void testCloneSnapshot() throws Exception {
        ...
        RestartFramework.at("after_table_create").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRestoreSnapshotQuotaExceed() throws Exception {
        ...
        ADMIN.snapshot(snapshot, tableName1);
        RestartFramework.at("after_namespace_modify").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
