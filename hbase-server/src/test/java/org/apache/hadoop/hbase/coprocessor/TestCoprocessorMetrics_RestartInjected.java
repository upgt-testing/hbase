...
public class TestCoprocessorMetrics_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCoprocessorMetrics_RestartInjected.class);
  ...
  public void testRegionObserverEndpoint() throws IOException, ServiceException {
    ...
    try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
      ...
      try (Table table = connection.getTable(tableName)) {
        ...
        RestartFramework.at("after_endpoint_execution")
          .on(UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
