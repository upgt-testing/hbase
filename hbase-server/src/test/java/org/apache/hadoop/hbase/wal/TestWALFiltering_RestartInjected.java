...
public class TestWALFiltering_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestWALFiltering_RestartInjected.class);
  ...
  private void fillTable() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_table_fill")
  ...
  public void testFlushedSequenceIdsSentToHMaster() throws IOException, InterruptedException,
    ...
    RestartFramework.at("after_flush_all_regions")
        ...
        .execute();
    Thread.sleep(10000);
    RestartFramework.at("before_sequence_id_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
