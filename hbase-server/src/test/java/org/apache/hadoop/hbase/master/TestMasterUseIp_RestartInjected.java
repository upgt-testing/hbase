...
public class TestMasterUseIp_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterUseIp_RestartInjected.class);
  ...
  public void testMasterUseIp() throws Exception {
    ...
    RestartFramework.at("after_get_master_hostname")
        .on(CLUSTER)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_ip_verification")
        .on(CLUSTER)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
