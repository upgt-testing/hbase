...
public class TestLockManager_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestLockManager_RestartInjected.class);
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestLockManager_RestartInjected.class);
    ...
    public void testMasterLockAcquireTimeout() throws Exception {
        ...
        assertTrue(lock.tryAcquire(2000));
        // wait less than other lock's timeout
