...
public class TestAsyncAdminClearMasterStubCache_RestartInjected extends TestAsyncAdminBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncAdminClearMasterStubCache_RestartInjected.class);
  ...
  public void testClearMasterStubCache() throws Exception {
    ...
    RestartFramework.at("after_cache_master_stub")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    cluster.startMaster();
    RestartFramework.at("after_master_restart_same_port")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_socket_ready")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
