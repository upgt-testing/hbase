...
public class TestEndToEndSplitTransaction_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestEndToEndSplitTransaction_RestartInjected.class);
  ...
  public void testCanSplitJustAfterASplit() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_get_references")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFromClientSideWhileSplitting() throws Throwable {
    ...
    RestartFramework.at("after_chore_schedule")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
