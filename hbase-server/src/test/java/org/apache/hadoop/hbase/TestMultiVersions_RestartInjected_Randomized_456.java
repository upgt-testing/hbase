...
public class TestMultiVersions_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestMultiVersions_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestMultiVersions_RestartInjected.class);
    ...
    public static void setUpBeforeClass() throws Exception {
        cluster = UTIL.startMiniCluster(NUM_SLAVES);
    }
    ...
    public void testGetRowVersions() throws Exception {
        ...
        StartMiniClusterOption option = StartMiniClusterOption.builder().numRegionServers(NUM_SLAVES).build();
