 ...
 */
public abstract class AbstractTestLogRolling_RestartInjected {
  ...
  public AbstractTestLogRolling_RestartInjected() {
    this.server = null;
    this.tableName = null;
  ...
  public void testLogRolling() throws Exception {
    ...
    log.rollWriter();
    RestartFramework.at("after_log_roll")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_flush_all_regions")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCompactionRecordDoesntBlockRolling() throws Exception {
    ...
    try (Table t = TEST_UTIL.getConnection().getTable(TableName.META_TABLE_NAME);
      ...
      RestartFramework.at("after_initial_flushes")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
