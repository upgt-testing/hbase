...
public class TestMultiParallel_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMultiParallel_RestartInjected.class);
    ...
    try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration())) {
      ...
      try {
        try (Table t = connection.getTable(TEST_TABLE, executor)) {
          ...
          RestartFramework.at("after_batch_put")
  ...
  private void doTestFlushCommits(boolean doAbort) throws Exception {
    ...
    if (doAbort) {
      ...
      RestartFramework.at("after_abort_recovery")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testBatchWithDelete() throws Exception {
    ...
    RestartFramework.at("after_batch_delete")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testBatchWithIncrementAndAppend() throws Exception {
    ...
    RestartFramework.at("after_increment_append")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonceCollision() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_increment")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      ConnectionImplementation.injectNonceGeneratorForTesting((ClusterConnection) connection,
        oldCnm);
    }
  }
  ...
  public void testBatchWithMixedActions() throws Exception {
    ...
    RestartFramework.at("after_mixed_batch")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
