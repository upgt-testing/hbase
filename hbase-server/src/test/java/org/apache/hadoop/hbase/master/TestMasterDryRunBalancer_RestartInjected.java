...
public class TestMasterDryRunBalancer_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterDryRunBalancer_RestartInjected.class);
  ...
  public void testDryRunBalancer() throws Exception {
    ...
    RestartFramework.at("after_disable_balancer")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_unbalance")
        .on(cluster)
    ...
    RestartFramework.at("after_dry_run_balance")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
