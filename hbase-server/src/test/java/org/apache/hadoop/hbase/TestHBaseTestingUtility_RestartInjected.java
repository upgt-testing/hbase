...
public class TestHBaseTestingUtility_RestartInjected {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestHBaseTestingUtility_RestartInjected.class);
  ...
  public void testMiniCluster() throws Exception {
    ...
    try {
      RestartFramework.at("at_50_percent")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMiniClusterWithSSLOn() throws Exception {
    final String BASEDIR = System.getProperty("test.build.dir", "target/test-dir") + "/"
      + TestHBaseTestingUtility_RestartInjected.class.getSimpleName();
  ...
  public void testMultipleStartStop() throws Exception {
    ...
    htu1.getDFSCluster().getFileSystem().create(foo);
    RestartFramework.at("after_second_file_create")
        .on(cluster2)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOverridingOfDefaultPorts() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("at_50_percent_custom")
          .on(customCluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
