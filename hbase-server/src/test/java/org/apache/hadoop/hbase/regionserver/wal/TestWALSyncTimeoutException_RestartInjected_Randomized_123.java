...
public class TestWALSyncTimeoutException_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestWALSyncTimeoutException_RestartInjected.class);
    ...
    public void testWALSyncWriteException() throws Exception {
        ...
        try {
            ...
            Thread.sleep(2000);
            RestartFramework.at("before_timeout_test").on(HTU.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            testWALTimout = true;
            /**
