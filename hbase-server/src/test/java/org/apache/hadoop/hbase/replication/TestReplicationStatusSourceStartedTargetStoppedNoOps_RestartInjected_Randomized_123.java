...
public class TestReplicationStatusSourceStartedTargetStoppedNoOps_RestartInjected_Randomized_123 extends TestReplicationBase {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestReplicationStatusSourceStartedTargetStoppedNoOps_RestartInjected.class);
