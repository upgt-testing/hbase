...
public class TestCompactSplitThread_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCompactSplitThread_RestartInjected.class);
  ...
  public void testThreadPoolSizeTuning() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_config_update_smaller")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFlushWithTableCompactionDisabled() throws Exception {
    ...
    RestartFramework.at("after_flush_loop")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFlushWithRegionReplicas() throws Exception {
    ...
    RestartFramework.at("after_flush_loop_with_replicas")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
