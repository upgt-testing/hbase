...
public class TestHbck_RestartInjected {
  @ClassRule
  ...
  public void testBypassProcedure() throws Exception {
    ...
    RestartFramework.at("after_bypass_procedure")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetTableStateInMeta() throws Exception {
    ...
    RestartFramework.at("after_set_table_state_disabled")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_set_table_state_enabled")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetRegionStateInMeta() throws Exception {
    ...
    RestartFramework.at("after_restore_region_state")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAssigns() throws Exception {
    ...
    try (Admin admin = TEST_UTIL.getConnection().getAdmin()) {
      ...
      waitOnPids(pids);
      RestartFramework.at("after_first_unassigns")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      waitOnPids(pids);
      RestartFramework.at("after_assigns")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testScheduleSCP() throws Exception {
    ...
    RestartFramework.at("after_schedule_scp")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRunHbckChore() throws Exception {
    ...
    RestartFramework.at("after_run_hbck_chore")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
