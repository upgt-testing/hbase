...
public class TestSplitTransactionOnCluster_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSplitTransactionOnCluster_RestartInjected.class);
  ...
  public void testRITStateForRollback() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_table_create_and_data_insert")
        .on(cluster)
      ...
      RestartFramework.at("after_balancer_and_janitor_config")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_find_splittable_region")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_region_online")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSplitFailedCompactionAndSplit() throws Exception {
    ...
    RestartFramework.at("after_compaction_request")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_region_initialize")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
