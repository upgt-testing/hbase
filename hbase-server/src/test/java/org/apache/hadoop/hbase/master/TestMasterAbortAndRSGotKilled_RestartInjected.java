...
public class TestMasterAbortAndRSGotKilled_RestartInjected {
  private static Logger LOG =
    LoggerFactory.getLogger(TestMasterAbortAndRSGotKilled_RestartInjected.class.getName());

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterAbortAndRSGotKilled_RestartInjected.class);
  ...
  public void test() throws Exception {
    ...
    RestartFramework.at("after_countdown_latch")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
