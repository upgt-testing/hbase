...
public class TestRegionMover2_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionMover2_RestartInjected.class);
  ...
  public void testFailedRegionMove() throws Exception {
    ...
    try (RegionMover rm = rmBuilder.build()) {
      ...
      RestartFramework.at("after_offline_region")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void regionIsolationOperation(ServerName sourceServerName,
    ...
    try (RegionMover rm = rmBuilder.build()) {
      ...
      rm.isolateRegions();
      RestartFramework.at("after_region_isolate")
          .on(cluster)
          .restart("regionserver")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
