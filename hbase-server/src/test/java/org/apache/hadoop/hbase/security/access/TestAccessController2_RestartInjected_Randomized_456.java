...
public class TestAccessController2_RestartInjected_Randomized_456 extends SecureTestUtil {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestAccessController2_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestAccessController2_RestartInjected.class);
    ...
    public void setUp() throws Exception {
        RestartFramework.at("after_namespace_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCreateWithCorrectOwner() throws Exception {
        ...
        // table just created
        List<UserPermission> perms = PermissionStorage.getTablePermissions(conf, testTable.getTableName()).get(testUser.getShortName());
        RestartFramework.at("after_user_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_grant_global_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertNotNull(perms);
    ...
    public void testCreateTableWithGroupPermissions() throws Exception {
        ...
        RestartFramework.at("after_grant_group_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
            ...
            RestartFramework.at("after_group_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
    ...
    public void testACLTableAccess() throws Exception {
        ...
        RestartFramework.at("after_grant_global_permissions").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_table_permissions").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        User nsAdmin = User.createUserForTesting(conf, "nsAdmin", new String[0]);
        SecureTestUtil.grantOnNamespace(TEST_UTIL, nsRead.getShortName(), testTable.getTableName().getNamespaceAsString(), Action.READ);
        SecureTestUtil.grantOnNamespace(TEST_UTIL, nsWrite.getShortName(), testTable.getTableName().getNamespaceAsString(), Action.WRITE);
        SecureTestUtil.grantOnNamespace(TEST_UTIL, nsCreate.getShortName(), testTable.getTableName().getNamespaceAsString(), Action.CREATE);
        SecureTestUtil.grantOnNamespace(TEST_UTIL, nsAdmin.getShortName(), testTable.getTableName().getNamespaceAsString(), Action.ADMIN);
        // Table users
        ...
        RestartFramework.at("after_grant_group_write").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_namespace_permissions").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SecureTestUtil.grantOnTable(TEST_UTIL, tableRead.getShortName(), testTable.getTableName(), null, null, Action.READ);
        SecureTestUtil.grantOnTable(TEST_UTIL, tableWrite.getShortName(), testTable.getTableName(), null, null, Action.WRITE);
        SecureTestUtil.grantOnTable(TEST_UTIL, tableCreate.getShortName(), testTable.getTableName(), null, null, Action.CREATE);
        SecureTestUtil.grantOnTable(TEST_UTIL, tableAdmin.getShortName(), testTable.getTableName(), null, null, Action.ADMIN);
        ...
        try {
            ...
            RestartFramework.at("after_acl_write_test").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            revokeGlobal(TEST_UTIL, TESTGROUP_1_NAME, Action.WRITE);
        }
        RestartFramework.at("after_grant_group_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ...
            RestartFramework.at("after_acl_read_test").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
   ...
   */
    ...
    public void testPostGrantAndRevokeScanAction() throws Exception {
        RestartFramework.at("after_revoke_family_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_family_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_revoke_table_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_table_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_revoke_qualifier_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_qualifier_read").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCoprocessorLoading() throws Exception {
        ...
        RestartFramework.at("after_load_coprocessor").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        cpHost.load(MyAccessController.class, Coprocessor.PRIORITY_HIGHEST, conf);
        RestartFramework.at("after_create_master_cp_env").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_create_rs_cp_env").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testACLZNodeDeletion() throws Exception {
        RestartFramework.at("after_zk_node_verification").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        String baseAclZNode = "/hbase/acl/";
        RestartFramework.at("after_cleanup_operations").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_namespace_create_znode").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_table_create_znode").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_grant_namespace_admin").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
