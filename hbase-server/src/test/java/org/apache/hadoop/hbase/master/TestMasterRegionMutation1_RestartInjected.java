...
public class TestMasterRegionMutation1_RestartInjected {

  private static final Logger LOG = LoggerFactory.getLogger(TestMasterRegionMutation1_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterRegionMutation1_RestartInjected.class);
  ...
  public void testMasterRegionMutations() throws Exception {
    ...
    RestartFramework.at("after_initial_hbck_check")
        .on(cluster)
        .restart("master")
        .withIndex(0)
