...
public class TestMasterRegionMutation2_RestartInjected extends TestMasterRegionMutation1 {

  private static final Logger LOG = LoggerFactory.getLogger(TestMasterRegionMutation2_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterRegionMutation2_RestartInjected.class);
  ...
  public void testMasterRegionMutations() throws Exception {
    ...
    RestartFramework.at("after_hbck_check")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_first_region_move")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_region_move")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_final_hbck_check")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
