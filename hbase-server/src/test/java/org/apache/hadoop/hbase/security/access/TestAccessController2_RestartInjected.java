...
public class TestAccessController2_RestartInjected extends SecureTestUtil {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAccessController2_RestartInjected.class);
  ...
  public void testCreateWithCorrectOwner() throws Exception {
    ...
    RestartFramework.at("after_grant_global_create")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_user_table_create")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateTableWithGroupPermissions() throws Exception {
    ...
    RestartFramework.at("after_grant_group_create")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_group_table_create")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testACLTableAccess() throws Exception {
    ...
    RestartFramework.at("after_grant_global_permissions")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_namespace_permissions")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_group_write")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_acl_write_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_group_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_acl_read_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPostGrantAndRevokeScanAction() throws Exception {
    ...
    RestartFramework.at("after_grant_table_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_revoke_table_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_family_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_revoke_family_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_qualifier_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_revoke_qualifier_read")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testCoprocessorLoading() throws Exception {
    ...
    RestartFramework.at("after_create_master_cp_env")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_rs_cp_env")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testACLZNodeDeletion() throws Exception {
    ...
    RestartFramework.at("after_namespace_create_znode")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_table_create_znode")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_namespace_admin")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_zk_node_verification")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cleanup_operations")
      .on(cluster)
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
