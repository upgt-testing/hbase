...
public abstract class AbstractTestAsyncTableRegionReplicasRead_RestartInjected {
  ...
  public static List<Object[]> params() {
    return Arrays.asList(
      new Supplier<?>[] { AbstractTestAsyncTableRegionReplicasRead_RestartInjected::getRawTable },
      new Supplier<?>[] { AbstractTestAsyncTableRegionReplicasRead_RestartInjected::getTable });
  }
  ...
  public void testNoReplicaRead() throws Exception {
    ...
    RestartFramework.at("after_read_check")
        .on(TEST_UTIL.getMiniHBaseCluster())
  ...
  public void testReplicaRead() throws Exception {
    ...
    AsyncTable<?> table = getTable.get();
    readAndCheck(table, -1);
    RestartFramework.at("after_replica_read")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadSpecificReplica() throws Exception {
    ...
    RestartFramework.at("after_specific_replica_reads")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
