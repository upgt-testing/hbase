...
public class TestReplicationSourceManagerJoin_RestartInjected extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationSourceManagerJoin_RestartInjected.class);
  ...
  public void testReplicationSourcesTerminate() throws Exception {
    ...
    RestartFramework.at("after_table_recovery")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_sources_verified")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
