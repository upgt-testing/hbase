...
public class TestCleanupMetaReplicaThroughConfig_RestartInjected extends MetaWithReplicasTestBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCleanupMetaReplicaThroughConfig_RestartInjected.class);
  ...
  public void testReplicaCleanup() throws Exception {
    ...
    RestartFramework.at("after_meta_replica_check")
