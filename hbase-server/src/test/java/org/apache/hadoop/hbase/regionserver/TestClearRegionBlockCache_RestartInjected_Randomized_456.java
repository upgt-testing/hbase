...
public class TestClearRegionBlockCache_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestClearRegionBlockCache_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestClearRegionBlockCache_RestartInjected.class);
    ...
    public void setup() throws Exception {
        ...
        RestartFramework.at("after_data_load_and_flush").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
