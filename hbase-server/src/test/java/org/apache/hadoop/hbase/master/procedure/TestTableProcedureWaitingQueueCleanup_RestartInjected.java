...
public class TestTableProcedureWaitingQueueCleanup_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestTableProcedureWaitingQueueCleanup_RestartInjected.class);
  ...
  private void testCreateDelete(Procedure<MasterProcedureEnv> proc) throws Exception {
    ...
    RestartFramework.at("after_submit_and_wait_procedure")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonTableProcedure() throws Exception {
    RestartFramework.at("before_test_non_table_procedure")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_non_table_procedure_complete")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNotSameTable() throws Exception {
    RestartFramework.at("before_test_not_same_table")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_not_same_table_complete")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
