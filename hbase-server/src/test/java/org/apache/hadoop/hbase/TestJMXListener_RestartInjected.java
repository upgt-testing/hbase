...
public class TestJMXListener_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestJMXListener_RestartInjected.class);
  ...
  public void testStart() throws Exception {
    ...
    RestartFramework.at("after_jmx_connect")
  ...
  public void testStop() throws Exception {
    ...
    RestartFramework.at("before_cluster_shutdown")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetRegionServerCoprocessors() throws Exception {
    RestartFramework.at("before_check_coprocessors")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
