...
public class TestRequestsPerSecondMetric_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestRequestsPerSecondMetric_RestartInjected.class);
     ...
     */
    void testNoNegativeSignAtRequestsPerSecond() throws IOException, InterruptedException {
        ...
        MetricsRegionServerWrapperImpl.RegionServerMetricsWrapperRunnable metricsServer = metricsWrapper.new RegionServerMetricsWrapperRunnable();
        metricsServer.run();
