...
public class TestReplicationStatusSourceStartedTargetStoppedWithRecovery_RestartInjected
  extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationStatusSourceStartedTargetStoppedWithRecovery_RestartInjected.class);
