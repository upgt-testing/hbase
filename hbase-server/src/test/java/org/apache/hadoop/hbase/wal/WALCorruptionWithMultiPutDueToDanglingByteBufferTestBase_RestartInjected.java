...
public abstract class WALCorruptionWithMultiPutDueToDanglingByteBufferTestBase_RestartInjected {

  private static final Logger LOG =
    LoggerFactory.getLogger(WALCorruptionWithMultiPutDueToDanglingByteBufferTestBase_RestartInjected.class);
