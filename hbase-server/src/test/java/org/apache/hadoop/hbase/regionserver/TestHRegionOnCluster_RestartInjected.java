...
public class TestHRegionOnCluster_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestHRegionOnCluster_RestartInjected.class);
  ...
  public void testDataCorrectnessReplayingRecoveredEdits() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_first_data_put")
        .on(cluster)
      ...
      RestartFramework.at("after_second_data_put")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_third_data_put")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
