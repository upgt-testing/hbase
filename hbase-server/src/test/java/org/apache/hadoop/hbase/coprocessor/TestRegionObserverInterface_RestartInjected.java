...
public class TestRegionObserverInterface_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionObserverInterface_RestartInjected.class);
  ...
  public void testCheckAndDeleteHooks() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_check_and_delete")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckAndIncrementHooks() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_check_and_increment")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
