...
public class TestAssignmentManagerUtil_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAssignmentManagerUtil_RestartInjected.class);
  ...
  public void testCreateUnassignProcedureForSplitFail() throws IOException {
    ...
    RestartFramework.at("after_get_primary_regions")
    ...
    RestartFramework.at("after_set_unassign_procedure")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateUnassignProceduresForMergeFail() throws IOException {
    ...
    RestartFramework.at("after_get_primary_regions_merge")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_set_unassign_procedure_merge")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
