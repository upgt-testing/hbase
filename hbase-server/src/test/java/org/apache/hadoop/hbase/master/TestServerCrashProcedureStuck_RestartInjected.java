...
public class TestServerCrashProcedureStuck_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestServerCrashProcedureStuck_RestartInjected.class);
  ...
  public void test() throws Exception {
    ...
    try (AsyncConnection conn =
      ...
      RestartFramework.at("after_resume_procedure")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
