...
public class TestTableDescriptorModificationFromClient_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestTableDescriptorModificationFromClient_RestartInjected.class);
    ...
    public void testModifyTable() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_verify_descriptor").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAddSameColumnFamilyTwice() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_add_column_family").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            verifyTableDescriptor(TABLE_NAME, FAMILY_0, FAMILY_1);
            RestartFramework.at("after_verify_two_families").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
    ...
    public void testDeleteSameColumnFamilyTwice() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_delete_column_family").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            verifyTableDescriptor(TABLE_NAME, FAMILY_0);
            RestartFramework.at("after_verify_one_family").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
