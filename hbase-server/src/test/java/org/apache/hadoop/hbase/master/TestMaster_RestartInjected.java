...
public class TestMaster_RestartInjected {
  ...
  public void testMasterOpsWhileSplitting() throws Exception {
    ...
    RestartFramework.at("after_split_trigger")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlockingHbkc1WithLockFile() throws IOException {
    ...
    RestartFramework.at("after_lock_file_check")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    TEST_UTIL.getMiniHBaseCluster().startMaster();
    assertTrue(fs.exists(hbckLockPath));
    RestartFramework.at("after_second_master_start")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
