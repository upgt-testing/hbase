...
public class TestRegionServerUseIp_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestRegionServerUseIp_RestartInjected.class);
    ...
    public void setup() throws Exception {
        ...
        RestartFramework.at("after_cluster_start_rs").on(CLUSTER).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
