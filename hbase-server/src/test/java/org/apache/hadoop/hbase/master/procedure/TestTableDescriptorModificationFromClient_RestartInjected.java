...
public class TestTableDescriptorModificationFromClient_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestTableDescriptorModificationFromClient_RestartInjected.class);
  ...
  public void testModifyTable() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_verify_descriptor")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAddSameColumnFamilyTwice() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_verify_two_families")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteSameColumnFamilyTwice() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_verify_one_family")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
