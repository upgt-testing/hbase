...
public class TestAsyncTableBatch_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableBatch_RestartInjected.class);
  ...
  public void testWithRegionServerFailover() throws Exception {
    ...
    RestartFramework.at("before_rs_failover")
        .on(cluster)
        .restart("regionserver")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMixed() throws Exception {
    ...
    RestartFramework.at("before_mixed_batch")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
