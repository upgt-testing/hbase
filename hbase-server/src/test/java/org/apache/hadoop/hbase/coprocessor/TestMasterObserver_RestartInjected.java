...
public class TestMasterObserver_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterObserver_RestartInjected.class);
  ...
  public static class CPMasterObserver implements MasterCoprocessor, MasterObserver {
    ...
    public void preModifyTableAction(final ObserverContext<MasterCoprocessorEnvironment> env,
      final TableName tableName, final TableDescriptor htd) throws IOException {
  ...
  public void testStarted() throws Exception {
    ...
    RestartFramework.at("after_coprocessor_verification")
        .on(cluster)
        .restart("master")
        .withIndex(0)
  ...
  public void testTableOperations() throws Exception {
    ...
    try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
      ...
      RestartFramework.at("after_merge_regions")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_truncate_table")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_delete_table")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_table_create_2")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_disable_table_2")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_modify_table_2")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_enable_table_2")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_delete_table_2")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSnapshotOperations() throws Exception {
    ...
    RestartFramework.at("after_table_disable")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_list_snapshot")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_clone_snapshot")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_restore_snapshot")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_delete_snapshot")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNamespaceOperations() throws Exception {
    ...
    RestartFramework.at("after_list_namespaces")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_namespace_descriptor")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRegionTransitionOperations() throws Exception {
    ...
    RestartFramework.at("after_multi_region_table_create")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try (RegionLocator r = UTIL.getConnection().getRegionLocator(tableName)) {
      ...
      RestartFramework.at("after_region_move")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_balance_switch")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_balance")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testTableDescriptorsEnumeration() throws Exception {
    ...
    RestartFramework.at("after_get_table_descriptors")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTableNamesEnumeration() throws Exception {
    ...
    RestartFramework.at("after_get_table_names")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAbortProcedureOperation() throws Exception {
    ...
    RestartFramework.at("after_abort_procedure")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetProceduresOperation() throws Exception {
    ...
    RestartFramework.at("after_get_procedures")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetLocksOperation() throws Exception {
    ...
    RestartFramework.at("after_get_locks")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testQueueLockAndLockHeartbeatOperations() throws Exception {
    ...
    RestartFramework.at("after_lock_heartbeat")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMasterStoreOperations() throws Exception {
    ...
    try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
      ...
      RestartFramework.at("after_master_store_flush")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUpdateConfiguration() throws Exception {
    ...
    try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
      ...
      RestartFramework.at("after_update_configuration")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
