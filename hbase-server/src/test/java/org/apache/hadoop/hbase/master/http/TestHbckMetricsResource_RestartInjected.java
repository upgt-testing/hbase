...
public class TestHbckMetricsResource_RestartInjected {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestHbckMetricsResource_RestartInjected.class);
  ...
  private static final class ClassSetup extends ExternalResource {
    ...
    protected void before() throws Throwable {
      ...
      RestartFramework.at("after_table_create")
          .on(miniClusterRule.getTestingUtility().getMiniHBaseCluster())
      ...
      RestartFramework.at("after_mock_setup")
          .on(miniClusterRule.getTestingUtility().getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
