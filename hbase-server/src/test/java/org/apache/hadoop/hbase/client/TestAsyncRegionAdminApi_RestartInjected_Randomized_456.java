...
public class TestAsyncRegionAdminApi_RestartInjected_Randomized_456 extends TestAsyncAdminBase {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestAsyncRegionAdminApi_RestartInjected.class);
    ...
    public void testAssignRegionAndUnassignRegion() throws Exception {
        ...
        RestartFramework.at("after_unassign").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertTrue(regionStates.getRegionState(hri).isOpened());
        RestartFramework.at("after_region_assigned").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        // Refresh after master restart
        regionStates = am.getRegionStates();
        assertFalse(am.getRegionStates().getRegionStateNode(hri).isInTransition());
    ...
    public void testGetRegionByStateOfTable() throws Exception {
        ...
        RestartFramework.at("after_create_multi_region_table").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetOnlineRegions() throws Exception {
        ...
        RestartFramework.at("after_table_create_get_online").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        assertEquals(TEST_UTIL.getHBaseCluster().getLiveRegionServerThreads().size(), regionServerCount.get());
    }
    ...
    public void testFlushTableAndRegion() throws Exception {
        ...
        RestartFramework.at("after_table_flush").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCompactMob() throws Exception {
        ...
        RestartFramework.at("after_create_mob_table").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCompactRegionServer() throws Exception {
        ...
        RestartFramework.at("after_minor_compaction").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCompactionSwitchStates() throws Exception {
        ...
        RestartFramework.at("after_load_data_compaction_switch").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        serverNameList.add(serverName.getServerName());
        CompletableFuture<Map<ServerName, Boolean>> listCompletableFuture3 = admin.compactionSwitch(false, serverNameList);
        ...
        CompletableFuture<Map<ServerName, Boolean>> listCompletableFuture4 = admin.compactionSwitch(true, serverNameList);
    ...
    public void testCompact() throws Exception {
        ...
        RestartFramework.at("after_first_compaction_test").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Restore to default
        TEST_UTIL.getMiniHBaseCluster().getRegionServerThreads().forEach(thread -> {
            Configuration conf = thread.getRegionServer().getConfiguration();
    ...
    public void testNonExistentTableCompaction() {
        RestartFramework.at("between_compaction_tests").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
