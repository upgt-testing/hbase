...
public class TestRegionPlacement2_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionPlacement2_RestartInjected.class);
  ...
  public void testFavoredNodesPresentForRoundRobinAssignment() throws HBaseIOException {
    ...
    balancer.initialize();
    RestartFramework.at("after_balancer_init")
    ...
    RestartFramework.at("after_first_assignment")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_remove_primary")
      .on(TEST_UTIL.getHBaseCluster())
    ...
    RestartFramework.at("after_add_back_primary")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testFavoredNodesPresentForRandomAssignment() throws HBaseIOException {
    ...
    RestartFramework.at("after_first_random_assignment")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    // Make all the favored nodes unavailable for assignment
    removeMatchingServers(favoredNodesAfter, servers);
    RestartFramework.at("after_remove_all_favored_nodes")
      .on(TEST_UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
