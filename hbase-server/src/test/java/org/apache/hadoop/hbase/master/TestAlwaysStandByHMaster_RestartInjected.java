...
public class TestAlwaysStandByHMaster_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAlwaysStandByHMaster_RestartInjected.class);
  ...
  public void testAlwaysStandBy() throws Exception {
    ...
    RestartFramework.at("after_master_verification")
    ...
    RestartFramework.at("after_standby_verification")
        .on(testUtil.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_start_new_master")
        .on(testUtil.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
