...
public class TestQuotaObserverChoreRegionReports_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestQuotaObserverChoreRegionReports_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestQuotaObserverChoreRegionReports_RestartInjected.class);
  ...
  public void testReportExpiration() throws Exception {
    ...
    RestartFramework.at("after_report_received")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMissingReportsRemovesQuota() throws Exception {
    ...
    RestartFramework.at("after_violation")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_region_unassign")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
