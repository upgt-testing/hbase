...
public class TestRpcConnectionRegistry_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRpcConnectionRegistry_RestartInjected.class);
  ...
  public void testRegistryRPCs() throws Exception {
    ...
    RestartFramework.at("after_endpoints_refresh")
    ...
    RestartFramework.at("after_metadata_verify")
      .on(UTIL.getHBaseCluster())
      .restart("master")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
