...
public class TestOpenSeqNumUnexpectedIncrease_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestOpenSeqNumUnexpectedIncrease_RestartInjected.class);
    ...
    public void test() throws IOException, InterruptedException {
        ...
        RestartFramework.at("after_region_move").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
