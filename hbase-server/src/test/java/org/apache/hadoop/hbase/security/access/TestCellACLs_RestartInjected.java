...
public class TestCellACLs_RestartInjected extends SecureTestUtil {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCellACLs_RestartInjected.class);
  ...
  public void testCoveringCheck() throws Exception {
    ...
    grantOnTable(TEST_UTIL, USER_OTHER.getShortName(), testTable.getTableName(), TEST_FAMILY, null,
      Action.READ);
