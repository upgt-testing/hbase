...
public class TestBootstrapNodeUpdate_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestBootstrapNodeUpdate_RestartInjected.class);
  ...
  public void testUpdate() throws Exception {
    ...
    RestartFramework.at("after_master_bootstrap")
    ...
    RestartFramework.at("after_switch_to_regionservers")
        .on(UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_regionserver_kill")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_final_verification")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
