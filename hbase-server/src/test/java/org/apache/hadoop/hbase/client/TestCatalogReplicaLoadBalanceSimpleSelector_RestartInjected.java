...
public class TestCatalogReplicaLoadBalanceSimpleSelector_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCatalogReplicaLoadBalanceSimpleSelector_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestCatalogReplicaLoadBalanceSimpleSelector_RestartInjected.class);
  ...
  public void testMetaChangeFromReplicaNoReplica() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_meta_selector_create")
    ...
    RestartFramework.at("after_replica_selection_test")
        .on(TEST_UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_meta_replicas_reduced")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
