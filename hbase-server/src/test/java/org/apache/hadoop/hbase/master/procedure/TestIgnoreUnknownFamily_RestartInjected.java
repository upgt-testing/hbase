...
public class TestIgnoreUnknownFamily_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestIgnoreUnknownFamily_RestartInjected.class);
  ...
  public void testSplit()
    ...
    RestartFramework.at("after_get_region_split")
        .on(UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_add_storefile_split")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMerge()
    ...
    RestartFramework.at("after_get_regions_merge")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_add_storefile_merge")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_merge_complete")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
