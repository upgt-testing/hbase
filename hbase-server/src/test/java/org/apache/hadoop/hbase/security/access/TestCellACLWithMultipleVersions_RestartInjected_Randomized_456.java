...
public class TestCellACLWithMultipleVersions_RestartInjected_Randomized_456 extends SecureTestUtil {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestCellACLWithMultipleVersions_RestartInjected.class);
