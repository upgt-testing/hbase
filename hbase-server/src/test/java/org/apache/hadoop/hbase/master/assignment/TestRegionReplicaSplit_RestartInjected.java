...
public class TestRegionReplicaSplit_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionReplicaSplit_RestartInjected.class);
  ...
  public void testRegionReplicaSplitRegionAssignment() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_load_numeric_rows")
          .on(HTU.getMiniHBaseCluster())
      ...
      RestartFramework.at("after_get_regions_before_split")
          .on(HTU.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_split_table")
          .on(HTU.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_wait_for_split_regions")
          .on(HTU.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_verify_replica_distribution")
          .on(HTU.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAssignFakeReplicaRegion() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_create_fake_region_info")
          .on(HTU.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_assign_fake_region")
          .on(HTU.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_verify_region_not_online")
          .on(HTU.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
