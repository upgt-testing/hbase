...
public class TestMasterChoreScheduled_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterChoreScheduled_RestartInjected.class);
  ...
  public void testDefaultScheduledChores() throws Exception {
    ...
    RestartFramework.at("after_check_hfile_cleaner")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_check_balancer_chore")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_check_catalog_janitor")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
