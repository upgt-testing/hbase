...
public class TestClaimReplicationQueue_RestartInjected extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClaimReplicationQueue_RestartInjected.class);
  ...
  public void testClaim() throws Exception {
    ...
    RestartFramework.at("after_disable_peers")
    ...
    RestartFramework.at("after_load_tables")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_stop_rs")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_start_new_rs")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_enable_peers")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
