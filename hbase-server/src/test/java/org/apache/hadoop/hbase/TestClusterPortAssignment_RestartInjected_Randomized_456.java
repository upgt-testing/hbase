...
public class TestClusterPortAssignment_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestClusterPortAssignment_RestartInjected.class);

    private static final HBaseTestingUtility TEST_UTIL = new HBaseTestingUtility();

    private static final Logger LOG = LoggerFactory.getLogger(TestClusterPortAssignment_RestartInjected.class);
    ...
    public void testClusterPortAssignment() throws Exception {
        ...
        do {
            ...
            try {
                ...
                RestartFramework.at("after_master_port_verification").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
                ...
                RestartFramework.at("after_rs_port_verification").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            } catch (Exception e) {
