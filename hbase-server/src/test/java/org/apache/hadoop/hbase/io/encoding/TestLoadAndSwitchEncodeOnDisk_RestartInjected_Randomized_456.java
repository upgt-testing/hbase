...
public class TestLoadAndSwitchEncodeOnDisk_RestartInjected_Randomized_456 extends TestMiniClusterLoadSequential {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestLoadAndSwitchEncodeOnDisk_RestartInjected.class);
    ...
    public TestLoadAndSwitchEncodeOnDisk_RestartInjected_Randomized_456() {
    ...
    public void loadTest() throws Exception {
        ...
        RestartFramework.at("after_modify_column").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_enable_table").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
