...
public abstract class TestReplicationSourceManager_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationSourceManager_RestartInjected.class);
  ...
  public void testLogRoll() throws Exception {
    ...
    RestartFramework.at("after_manager_init")
        .on(utility.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_log_cleanup")
        .on(utility.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
