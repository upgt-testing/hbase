...
public class TestSequenceIdMonotonicallyIncreasing_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSequenceIdMonotonicallyIncreasing_RestartInjected.class);
  ...
  public void testSplit()
    ...
    RestartFramework.at("before_region_split")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMerge()
    ...
    RestartFramework.at("before_region_merge")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
