...
public class TestClientOperationTimeout_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClientOperationTimeout_RestartInjected.class);
  ...
  public void testGetTimeout() throws Exception {
    ...
    RestartFramework.at("before_get_timeout_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPutTimeout() throws Exception {
    ...
    RestartFramework.at("before_put_timeout_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiTimeout() throws Exception {
    ...
    RestartFramework.at("before_batch_timeout_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiGetMetaTimeout() throws Exception {
    ...
    try (Connection specialConnection = ConnectionFactory.createConnection(conf);
      ...
      RestartFramework.at("after_connection_create_meta_timeout")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiGetRetryTimeout() throws Exception {
    ...
    try (Connection specialConnection = ConnectionFactory.createConnection(conf);
      ...
      RestartFramework.at("after_connection_create_retry_timeout")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiOperationTimeoutWithLocationError()
    ...
    try (Connection specialConnection = ConnectionFactory.createConnection(conf);
      ...
      RestartFramework.at("after_connection_create_location_error")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testScanTimeout() throws Exception {
    ...
    RestartFramework.at("before_scan_timeout_test")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
