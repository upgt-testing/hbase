...
public class TestFSErrorsExposed_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFSErrorsExposed_RestartInjected.class);
  ...
  public void testFullSystemBubblesFSErrors() throws Exception {
    ...
    try {
      ...
      try (Table table = util.getConnection().getTable(tableName)) {
        ...
        RestartFramework.at("after_load_and_flush")
          .on(util.getMiniHBaseCluster())
        ...
        RestartFramework.at("after_count_rows")
          .on(util.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
