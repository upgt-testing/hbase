...
public class TestRegionServerCoprocessorExceptionWithAbort_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionServerCoprocessorExceptionWithAbort_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestRegionServerCoprocessorExceptionWithAbort_RestartInjected.class);
