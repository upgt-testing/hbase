...
public class TestStoreFileListFilePrinter_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestStoreFileListFilePrinter_RestartInjected.class);
  ...
  private void createTable() throws IOException {
    ...
    RestartFramework.at("after_table_create_in_helper")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_put_in_helper")
        ...
        .execute();
    UTIL.flush(tn);
    RestartFramework.at("after_flush_in_helper")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
