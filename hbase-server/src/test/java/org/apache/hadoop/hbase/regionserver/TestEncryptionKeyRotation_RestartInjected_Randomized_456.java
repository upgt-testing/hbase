...
public class TestEncryptionKeyRotation_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestEncryptionKeyRotation_RestartInjected.class);
    ...
    public static void setUp() throws Exception {
        ...
        RestartFramework.at("after_cluster_start_rs").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
