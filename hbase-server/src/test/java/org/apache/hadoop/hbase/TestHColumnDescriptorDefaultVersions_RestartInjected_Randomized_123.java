...
public class TestHColumnDescriptorDefaultVersions_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestHColumnDescriptorDefaultVersions_RestartInjected.class);
