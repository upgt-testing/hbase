...
public class TestBlockEvictionOnRegionMovement_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestBlockEvictionOnRegionMovement_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestBlockEvictionOnRegionMovement_RestartInjected.class);
  ...
  public void testBlockEvictionOnGracefulStop() throws Exception {
    ...
    RestartFramework.at("after_cache_check")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    Thread.sleep(500);
    RestartFramework.at("after_regionserver_restart")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
