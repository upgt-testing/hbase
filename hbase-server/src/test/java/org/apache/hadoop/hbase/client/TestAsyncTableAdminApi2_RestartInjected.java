...
public class TestAsyncTableAdminApi2_RestartInjected extends TestAsyncAdminBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableAdminApi2_RestartInjected.class);
  ...
  public void testDisableCatalogTable() throws Exception {
    ...
    RestartFramework.at("after_disable_meta_attempt")
  ...
  public void testCompactionTimestamps() throws Exception {
    ...
    RestartFramework.at("after_multiple_flushes")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
