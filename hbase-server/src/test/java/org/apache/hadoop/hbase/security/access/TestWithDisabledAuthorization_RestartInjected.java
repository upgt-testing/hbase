...
public class TestWithDisabledAuthorization_RestartInjected extends SecureTestUtil {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestWithDisabledAuthorization_RestartInjected.class);
  ...
  public void setUp() throws Exception {
    ...
    RestartFramework.at("after_grants_setup")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPassiveGrantRevoke() throws Exception {
    ...
    grantOnTable(TEST_UTIL, tblUser.getShortName(), testTable.getTableName(), TEST_FAMILY, null,
      Permission.Action.READ);
    RestartFramework.at("after_grant")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    revokeFromTable(TEST_UTIL, tblUser.getShortName(), testTable.getTableName(), TEST_FAMILY, null,
      Permission.Action.READ);
    RestartFramework.at("after_revoke")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPassiveCellPermissions() throws Exception {
    ...
    RestartFramework.at("after_cell_puts")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
