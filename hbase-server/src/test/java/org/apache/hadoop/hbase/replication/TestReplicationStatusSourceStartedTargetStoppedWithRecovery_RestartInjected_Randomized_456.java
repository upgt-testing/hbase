...
public class TestReplicationStatusSourceStartedTargetStoppedWithRecovery_RestartInjected_Randomized_456 extends TestReplicationBase {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestReplicationStatusSourceStartedTargetStoppedWithRecovery_RestartInjected.class);
    ...
    public void testReplicationStatusSourceStartedTargetStoppedWithRecovery() throws Exception {
        ...
        RestartFramework.at("after_get_cluster_metrics").on(UTIL1.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
