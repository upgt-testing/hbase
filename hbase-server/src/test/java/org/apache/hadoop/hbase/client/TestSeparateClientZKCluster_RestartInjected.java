...
public class TestSeparateClientZKCluster_RestartInjected {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSeparateClientZKCluster_RestartInjected.class);
  ...
  public void testMasterSwitch() throws Exception {
    ...
    try (Admin admin = conn.getAdmin()) {
      ...
      RestartFramework.at("after_master_switch")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMetaRegionMove() throws Exception {
    ...
    try (Admin admin = conn.getAdmin(); Table table = conn.getTable(tn);
      ...
      RestartFramework.at("after_user_region_move")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMetaMoveDuringClientZkClusterRestart() throws Exception {
    ...
    try (Admin admin = conn.getAdmin(); Table table = conn.getTable(tn)) {
      ...
      RestartFramework.at("after_meta_server_stop")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testChangeMetaReplicaCount() throws Exception {
    ...
    try (RegionLocator locator =
      ...
      RestartFramework.at("after_increase_replicas_to_3")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_decrease_replicas_to_2")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
