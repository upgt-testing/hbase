...
public class TestFavoredStochasticLoadBalancer_RestartInjected extends BalancerTestBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFavoredStochasticLoadBalancer_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestFavoredStochasticLoadBalancer_RestartInjected.class);
