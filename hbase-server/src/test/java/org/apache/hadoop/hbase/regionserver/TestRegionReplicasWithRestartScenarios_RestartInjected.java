...
public class TestRegionReplicasWithRestartScenarios_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionReplicasWithRestartScenarios_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestRegionReplicasWithRestartScenarios_RestartInjected.class);
  ...
  public void testRegionReplicasCreated() throws Exception {
    ...
    RestartFramework.at("after_replica_distribution_verification")
  ...
  public void testWhenRestart() throws Exception {
    ...
    RestartFramework.at("after_new_regionserver_start")
        .on(HTU.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_regionserver_stop_and_table_available")
        .on(HTU.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_final_replica_distribution_verification")
        .on(HTU.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
