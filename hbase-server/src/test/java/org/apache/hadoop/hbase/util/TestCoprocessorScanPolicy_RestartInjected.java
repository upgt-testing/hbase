...
public class TestCoprocessorScanPolicy_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCoprocessorScanPolicy_RestartInjected.class);
  ...
  public TestCoprocessorScanPolicy_RestartInjected(boolean parallelSeekEnable) {
  ...
  public void testBaseCases() throws Exception {
    ...
    t.put(p);
    RestartFramework.at("after_initial_puts")
    ...
    t.put(p);
    RestartFramework.at("after_version_override")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTTL() throws Exception {
    ...
    t.put(p);
    RestartFramework.at("after_ttl_override")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
