...
public class TestSecurityInfoAndHBasePolicyProviderMatch_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSecurityInfoAndHBasePolicyProviderMatch_RestartInjected.class);
  ...
  public void testMatches() {
    ...
    RestartFramework.at("after_verify_master_rpc_services")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_regionserver_rpc_services")
        .on(cluster)
