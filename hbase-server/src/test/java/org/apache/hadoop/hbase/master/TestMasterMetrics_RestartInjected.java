...
public class TestMasterMetrics_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterMetrics_RestartInjected.class);
  ...
  public void testClusterRequests() throws Exception {
    ...
    RestartFramework.at("after_first_report")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_second_report")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDefaultMasterMetrics() throws Exception {
    ...
    RestartFramework.at("after_verify_server_metrics")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_all_metrics")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDefaultMasterProcMetrics() throws Exception {
    ...
    RestartFramework.at("after_verify_wal_metrics")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
