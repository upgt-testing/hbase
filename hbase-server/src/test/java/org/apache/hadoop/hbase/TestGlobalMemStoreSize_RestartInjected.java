...
public class TestGlobalMemStoreSize_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestGlobalMemStoreSize_RestartInjected.class);
  ...
  public void testGlobalMemStore() throws Exception {
    ...
    RestartFramework.at("after_region_assignment")
      .on(cluster)
    ...
    RestartFramework.at("after_memstore_check")
      .on(cluster)
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
