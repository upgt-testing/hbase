...
public class TestSpaceQuotaOnBulkLoad_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSpaceQuotaOnBulkLoad_RestartInjected.class);
  ...
  public void testNoBulkLoadsWithNoWrites() throws Exception {
    ...
    RestartFramework.at("after_bulk_load_rejection")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAtomicBulkLoadUnderQuota() throws Exception {
    ...
    RestartFramework.at("after_bulk_load_and_table_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
