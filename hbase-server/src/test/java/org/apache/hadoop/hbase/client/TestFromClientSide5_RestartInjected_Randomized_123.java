...
public class TestFromClientSide5_RestartInjected_Randomized_123 extends FromClientSideBase {
    ...
    TestFromClientSide5_RestartInjected_Randomized_123() {
    }

    public TestFromClientSide5_RestartInjected_Randomized_123(Class<? extends ConnectionRegistry> registry, int numHedgedReqs) throws Exception {
