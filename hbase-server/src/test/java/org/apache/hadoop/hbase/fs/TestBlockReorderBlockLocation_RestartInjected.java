...
public class TestBlockReorderBlockLocation_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestBlockReorderBlockLocation_RestartInjected.class);
  ...
  public void testBlockLocation() throws Exception {
    ...
    for (int i = 0; i < 10; i++) {
      ...
      if (i == 0) {
        RestartFramework.at("during_block_reorder_check")
            .on(hbm)
            .restart("regionserver")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
