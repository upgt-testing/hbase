...
public class TestScannerLeaseCount_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestScannerLeaseCount_RestartInjected.class);
  ...
  public void itIncreasesScannerCount() throws Exception {
    RestartFramework.at("before_scanner_create")
    ...
    RestartFramework.at("after_scanner_operations")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void itDoesNotIncreaseScannerLeaseCount() throws Exception {
    ...
    RestartFramework.at("before_throttled_scanner_create")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_throttle_verification")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
