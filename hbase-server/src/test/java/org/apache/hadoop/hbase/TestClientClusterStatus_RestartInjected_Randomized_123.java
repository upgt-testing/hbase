...
public class TestClientClusterStatus_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestClientClusterStatus_RestartInjected.class);
    ...
    public void testLiveAndDeadServersStatus() throws Exception {
        ...
        RestartFramework.at("after_wait_for_regions").on(CLUSTER).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
