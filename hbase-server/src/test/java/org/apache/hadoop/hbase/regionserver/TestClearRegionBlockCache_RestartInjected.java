...
public class TestClearRegionBlockCache_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClearRegionBlockCache_RestartInjected.class);
  ...
  public void setup() throws Exception {
    ...
    RestartFramework.at("after_data_load_and_flush")
      .on(cluster)
