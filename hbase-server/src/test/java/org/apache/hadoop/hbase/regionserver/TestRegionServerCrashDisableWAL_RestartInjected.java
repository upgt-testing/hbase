...
public class TestRegionServerCrashDisableWAL_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionServerCrashDisableWAL_RestartInjected.class);
  ...
  public static void setUp() throws Exception {
    ...
    RestartFramework.at("after_region_placement")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
