...
public class TestNamespaceAuditor_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestNamespaceAuditor_RestartInjected.class);
  ...
  public void testValidQuotas() throws Exception {
    ...
    RestartFramework.at("after_get_filesystem")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteTable() throws Exception {
    ...
    RestartFramework.at("after_first_table_delete")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRecreateTableWithSameNameAfterFirstTimeFailure() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_failed_table_create")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_successful_table_create")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRestoreSnapshotQuotaExceed() throws Exception {
    ...
    RestartFramework.at("after_namespace_modify")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
