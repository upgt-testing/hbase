...
public class TestReplicationStatus_RestartInjected extends TestReplicationBase {
  private static final Logger LOG = LoggerFactory.getLogger(TestReplicationStatus_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationStatus_RestartInjected.class);
  ...
  public void testReplicationStatus() throws Exception {
    ...
    RestartFramework.at("after_rs_start")
    ...
    RestartFramework.at("after_insert_rows")
        .on(UTIL1.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_metrics_check")
        .on(UTIL1.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failover_metrics_check")
        .on(UTIL1.getHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
