...
public class TestAssignmentManagerMetrics_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAssignmentManagerMetrics_RestartInjected.class);
  ...
  public void testRITAssignmentManagerMetrics() throws Exception {
    ...
    try (Table table = TEST_UTIL.createTable(TABLENAME, FAMILY)) {
      ...
      RestartFramework.at("after_first_metrics_check")
          .on(CLUSTER)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_wait_rit_completion")
          .on(CLUSTER)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
