...
public class TestRegionServerAbortTimeout_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionServerAbortTimeout_RestartInjected.class);
  ...
  public void testAbortTimeout() throws Exception {
    ...
    RestartFramework.at("after_writer_start")
      .on(UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(1)
      .withMode(RestartMode.GRACEFUL)
