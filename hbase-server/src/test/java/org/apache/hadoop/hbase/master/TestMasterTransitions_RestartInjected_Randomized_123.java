...
public class TestMasterTransitions_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestMasterTransitions_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestMasterTransitions_RestartInjected.class);
    ...
    public static void beforeAllTests() throws Exception {
        ...
        RestartFramework.at("after_get_region_count").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        t.close();
    }
    ...
    public void setup() throws IOException {
        ...
        RestartFramework.at("after_ensure_region_servers").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
