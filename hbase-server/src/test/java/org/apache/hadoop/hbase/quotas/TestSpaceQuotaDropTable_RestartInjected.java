...
public class TestSpaceQuotaDropTable_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSpaceQuotaDropTable_RestartInjected.class);
  ...
  public void testSetQuotaAndThenDropTableWithRegionReport() throws Exception {
    ...
    RestartFramework.at("after_region_report")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void setQuotaAndThenDropTable(SpaceViolationPolicy policy) throws Exception {
    ...
    RestartFramework.at("after_quota_violation")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_table_recreate")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
