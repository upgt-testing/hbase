 ...
 */
public abstract class WALCorruptionDueToDanglingByteBufferTestBase_RestartInjected {

  private static final Logger LOG =
    LoggerFactory.getLogger(WALCorruptionDueToDanglingByteBufferTestBase_RestartInjected.class);
  ...
  public void test() throws Exception {
    ...
    try (Table table = UTIL.getConnection().getTable(TABLE_NAME)) {
      ...
      RestartFramework.at("after_async_puts")
