...
public class TestRegionServerAbortTimeout_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestRegionServerAbortTimeout_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestRegionServerAbortTimeout_RestartInjected.class);
    ...
    public void testAbortTimeout() throws Exception {
        ...
        RestartFramework.at("after_writer_start").on(UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
