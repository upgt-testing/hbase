 ...
 */
public abstract class AbstractTestDLS_RestartInjected {
  ...
  public void testMasterStartsUpWithLogSplittingWork() throws Exception {
    ...
    try (Table ht = installTable(numRegionsToCreate)) {
      ...
      RestartFramework.at("after_rs_abort")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_regions_online")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testThreeRSAbort() throws Exception {
    ...
    try (Table table = installTable(numRegionsToCreate)) {
      ...
      RestartFramework.at("after_data_populate")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_kill_region_servers")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
