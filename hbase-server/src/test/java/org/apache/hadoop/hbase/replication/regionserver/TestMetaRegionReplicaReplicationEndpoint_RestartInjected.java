...
public class TestMetaRegionReplicaReplicationEndpoint_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMetaRegionReplicaReplicationEndpoint_RestartInjected.class);
  private static final Logger LOG =
    LoggerFactory.getLogger(TestMetaRegionReplicaReplicationEndpoint_RestartInjected.class);
  ...
  public void before() throws Exception {
    ...
    HTU.waitFor(30000, () -> HTU.getMiniHBaseCluster().getRegions(TableName.META_TABLE_NAME).size()
        >= numOfMetaReplica);
    RestartFramework.at("after_cluster_start_and_meta_replicas_ready")
