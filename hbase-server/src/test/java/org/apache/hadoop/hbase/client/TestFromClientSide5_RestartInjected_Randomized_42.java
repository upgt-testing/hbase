...
public class TestFromClientSide5_RestartInjected_Randomized_42 extends FromClientSideBase {
    ...
    TestFromClientSide5_RestartInjected_Randomized_42() {
    }

    public TestFromClientSide5_RestartInjected_Randomized_42(Class<? extends ConnectionRegistry> registry, int numHedgedReqs) throws Exception {
