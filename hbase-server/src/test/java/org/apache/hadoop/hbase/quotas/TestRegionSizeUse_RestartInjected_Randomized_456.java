...
public class TestRegionSizeUse_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestRegionSizeUse_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestRegionSizeUse_RestartInjected.class);
    ...
    public void testBasicRegionSizeReports() throws Exception {
        ...
        RestartFramework.at("after_region_size_verification").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
