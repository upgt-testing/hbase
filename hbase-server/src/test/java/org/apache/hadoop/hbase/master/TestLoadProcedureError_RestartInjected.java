...
public class TestLoadProcedureError_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestLoadProcedureError_RestartInjected.class);
  ...
  public void testLoadError() throws Exception {
    ...
    waitNoMaster();
    FAIL_LOAD = false;
    RestartFramework.at("after_fail_load_clear")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_successful_master_init")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    FINISH_PROC = true;
    RestartFramework.at("after_finish_proc_set")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
