...
public class TestClientMetaServiceRPCs_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClientMetaServiceRPCs_RestartInjected.class);
  ...
  public void TestClusterID() throws Exception {
    ...
    RestartFramework.at("after_get_cluster_id")
    ...
    RestartFramework.at("after_cluster_id_rpc")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void TestActiveMaster() throws Exception {
    ...
    RestartFramework.at("after_get_active_master")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_active_master_rpc")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void TestMetaLocations() throws Exception {
    ...
    RestartFramework.at("after_get_meta_locations")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_meta_locations_rpc")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
