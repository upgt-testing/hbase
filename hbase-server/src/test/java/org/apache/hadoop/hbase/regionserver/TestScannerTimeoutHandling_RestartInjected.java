...
public class TestScannerTimeoutHandling_RestartInjected {

  private static final Logger LOG = LoggerFactory.getLogger(TestScannerTimeoutHandling_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestScannerTimeoutHandling_RestartInjected.class);
  ...
  public void testExceededClientDeadline() throws Exception {
    ...
    RestartFramework.at("after_data_put")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
