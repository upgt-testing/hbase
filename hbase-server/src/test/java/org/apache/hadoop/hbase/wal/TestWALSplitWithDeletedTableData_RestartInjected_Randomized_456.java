...
public class TestWALSplitWithDeletedTableData_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestWALSplitWithDeletedTableData_RestartInjected.class);
    ...
    public void testWALSplitWithDeletedTableData() throws Exception {
        ...
        RestartFramework.at("after_table_delete").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        cluster = TEST_UTIL.getMiniHBaseCluster();
        RestartFramework.at("after_wal_split").on(TEST_UTIL.getMiniHBaseCluster()).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
