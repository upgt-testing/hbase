...
public class TestReplicationStatusAfterLagging_RestartInjected extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationStatusAfterLagging_RestartInjected.class);
  ...
  public void testReplicationStatusAfterLagging() throws Exception {
    ...
    RestartFramework.at("after_target_cluster_start")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
