...
public class TestReplicationMarker_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationMarker_RestartInjected.class);
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    RestartFramework.at("after_cluster2_start")
        .on(cluster2)
    ...
    RestartFramework.at("after_cluster1_start")
        .on(cluster1)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReplicationMarkerRow() throws Exception {
    ...
    Thread.sleep(5000);
    RestartFramework.at("after_first_sleep")
        .on(cluster1)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_replicated_entries")
        .on(cluster1)
        .restart("regionserver")
        .withIndex(0)
    ...
    Thread.sleep(5000);
    RestartFramework.at("after_second_sleep")
        .on(cluster1)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_wait_for_tracker_rows")
        .on(cluster2)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_rows")
        .on(cluster2)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_marker_rows")
        .on(cluster2)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_table_existence")
        .on(cluster1)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
