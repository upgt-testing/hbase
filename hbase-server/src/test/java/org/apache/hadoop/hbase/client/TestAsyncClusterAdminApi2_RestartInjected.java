...
public class TestAsyncClusterAdminApi2_RestartInjected extends TestAsyncAdminBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncClusterAdminApi2_RestartInjected.class);
  ...
  public void testStop() throws Exception {
    ...
    RestartFramework.at("before_stop_regionserver")
  ...
  public void testShutdown() throws Exception {
    ...
    RestartFramework.at("before_shutdown")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
