...
public class TestWALEventTracker_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestWALEventTracker_RestartInjected.class);
  ...
  public void testWALRolling() throws Exception {
    ...
    RestartFramework.at("after_wal_tracker_table_ready")
        .on(cluster)
    ...
    RestartFramework.at("after_wal_events_retrieved")
        .on(cluster)
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
