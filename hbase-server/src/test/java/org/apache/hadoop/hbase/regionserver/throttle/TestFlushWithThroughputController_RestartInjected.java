...
public class TestFlushWithThroughputController_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFlushWithThroughputController_RestartInjected.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestFlushWithThroughputController_RestartInjected.class);
  ...
  public void testFlushThroughputTuning() throws Exception {
    ...
    RestartFramework.at("after_put_operations")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
