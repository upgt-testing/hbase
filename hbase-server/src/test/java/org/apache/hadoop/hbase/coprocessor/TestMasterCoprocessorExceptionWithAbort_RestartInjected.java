...
public class TestMasterCoprocessorExceptionWithAbort_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterCoprocessorExceptionWithAbort_RestartInjected.class);
  ...
  public void testExceptionFromCoprocessorWhenCreatingTable() throws IOException {
    ...
    RestartFramework.at("after_zk_watcher_setup")
      .on(cluster)
    ...
    assertTrue(HMaster.getLoadedCoprocessors()
      .contains(TestMasterCoprocessorExceptionWithAbort_RestartInjected.BuggyMasterObserver.class.getName()));
