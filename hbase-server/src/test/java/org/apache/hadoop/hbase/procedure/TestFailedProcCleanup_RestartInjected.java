...
public class TestFailedProcCleanup_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFailedProcCleanup_RestartInjected.class);
  ...
  public void testFailCreateTableAction() throws Exception {
    ...
    try {
      ...
      LOG.debug("Ignoring exception: ", e);
      RestartFramework.at("after_failed_table_create_action")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
