...
public class TestHTableMultiplexerFlushCache_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestHTableMultiplexerFlushCache_RestartInjected.class);
  ...
  public void testOnRegionChange() throws Exception {
    ...
    try (RegionLocator r = TEST_UTIL.getConnection().getRegionLocator(tableName)) {
      ...
      RestartFramework.at("after_region_change")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
