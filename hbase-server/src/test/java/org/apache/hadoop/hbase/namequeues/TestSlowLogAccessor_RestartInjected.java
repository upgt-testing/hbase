...
public class TestSlowLogAccessor_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSlowLogAccessor_RestartInjected.class);
  ...
  public void testSlowLogRecords() throws Exception {
    ...
    RestartFramework.at("after_slowlog_table_ready")
        .on(cluster)
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_first_batch_records")
        .on(cluster)
    ...
    RestartFramework.at("after_all_records_added")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testHigherSlowLogs() throws Exception {
    ...
    RestartFramework.at("after_async_records_submit")
        .on(cluster)
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
