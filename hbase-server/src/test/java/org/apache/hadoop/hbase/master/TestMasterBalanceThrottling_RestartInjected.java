...
public class TestMasterBalanceThrottling_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterBalanceThrottling_RestartInjected.class);
  ...
  public void testThrottlingByBalanceInterval() throws Exception {
    ...
    RestartFramework.at("before_balance")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
