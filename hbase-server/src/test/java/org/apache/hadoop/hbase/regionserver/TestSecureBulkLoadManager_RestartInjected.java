...
public class TestSecureBulkLoadManager_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSecureBulkLoadManager_RestartInjected.class);
  ...
  public TestSecureBulkLoadManager_RestartInjected(Boolean useFileBasedSFT) {
  ...
  public void testForRaceCondition() throws Exception {
    ...
    RestartFramework.at("after_table_create")
        .on(testUtil.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
    ...
    RestartFramework.at("after_hfile_prepare_dir1")
        .on(testUtil.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_hfile_prepare_dir2")
        .on(testUtil.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_bulkload_threads_complete")
        .on(testUtil.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
