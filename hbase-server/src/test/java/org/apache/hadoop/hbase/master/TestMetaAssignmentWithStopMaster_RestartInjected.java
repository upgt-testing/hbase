...
public class TestMetaAssignmentWithStopMaster_RestartInjected {

  private static final Logger LOG = LoggerFactory.getLogger(TestMetaAssignmentWithStopMaster_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMetaAssignmentWithStopMaster_RestartInjected.class);
  ...
  public void testStopActiveMaster() throws Exception {
    ...
    RestartFramework.at("after_get_old_meta_server")
    ...
    RestartFramework.at("after_standby_master_active")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_new_master_initialized")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_new_meta_server")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
