...
public class TestScannerBlockSizeLimits_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestScannerBlockSizeLimits_RestartInjected.class);
  ...
  public void testCheckLimitAfterFilterRowKey() throws IOException {
    ...
    RestartFramework.at("after_filter_row_key_scan")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckLimitAfterFilteringRowCellsDueToFilterRow() throws IOException {
    ...
    RestartFramework.at("after_filter_row_scan")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckLimitAfterFilteringCell() throws IOException {
    ...
    ResultScanner scanner = table.getScanner(getBaseScan().setCaching(1)
    ...
    RestartFramework.at("after_filter_cell_scan")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckLimitAfterFilteringRowCells() throws IOException {
    ...
    RestartFramework.at("after_filter_row_cells_scan")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekNextUsingHint() throws IOException {
    ...
    RestartFramework.at("after_seek_scan")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
