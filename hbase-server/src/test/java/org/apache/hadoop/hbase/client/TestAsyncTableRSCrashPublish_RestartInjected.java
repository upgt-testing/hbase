...
public class TestAsyncTableRSCrashPublish_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableRSCrashPublish_RestartInjected.class);
  ...
  public void test() throws IOException, ExecutionException, InterruptedException {
    ...
    try (AsyncConnection connection = ConnectionFactory.createAsyncConnection(conf).get()) {
      ...
      RestartFramework.at("after_initial_get")
      ...
      RestartFramework.at("after_cache_clear")
          .on(UTIL.getMiniHBaseCluster())
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
