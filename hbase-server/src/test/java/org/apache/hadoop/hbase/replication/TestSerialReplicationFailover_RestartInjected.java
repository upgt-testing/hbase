...
public class TestSerialReplicationFailover_RestartInjected extends SerialReplicationTestBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSerialReplicationFailover_RestartInjected.class);
  ...
  public void testKillRS() throws Exception {
    ...
    RestartFramework.at("after_first_batch_put")
        .on(UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_second_batch_put")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
