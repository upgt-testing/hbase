...
public class TestMasterObserver_RestartInjected_Randomized_123 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestMasterObserver_RestartInjected.class);

    private static final Logger LOG = LoggerFactory.getLogger(TestMasterObserver_RestartInjected.class);
    ...
    public static class CPMasterObserver implements MasterCoprocessor, MasterObserver {
        ...
        @Override
        public void preMergeRegions(final ObserverContext<MasterCoprocessorEnvironment> ctx, final RegionInfo[] regionsToMerge) throws IOException {
            preMergeRegionsCalled = true;
        }

        @Override
        public void postMergeRegions(final ObserverContext<MasterCoprocessorEnvironment> ctx, final RegionInfo[] regionsToMerge) throws IOException {
        ...
        @Override
        public void preAbortProcedure(ObserverContext<MasterCoprocessorEnvironment> ctx, final long procId) throws IOException {
        ...
        @Override
        public void preAssign(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
            preAssignCalled = true;
        }

        @Override
        public void postAssign(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
        ...
        @Override
        public void preUnassign(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
            preUnassignCalled = true;
        }

        @Override
        public void postUnassign(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
        ...
        @Override
        public void preRegionOffline(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
            preRegionOfflineCalled = true;
        }

        @Override
        public void postRegionOffline(ObserverContext<MasterCoprocessorEnvironment> env, final RegionInfo regionInfo) throws IOException {
        ...
        @Override
        public void preBalance(ObserverContext<MasterCoprocessorEnvironment> env, BalanceRequest request) throws IOException {
            preBalanceCalled = true;
        }

        @Override
        public void postBalance(ObserverContext<MasterCoprocessorEnvironment> env, BalanceRequest request, List<RegionPlan> plans) throws IOException {
        ...
        @Override
        public void postSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot, final TableDescriptor hTableDescriptor) throws IOException {
        ...
        @Override
        public void preListSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot) throws IOException {
            preListSnapshotCalled = true;
        }

        @Override
        public void postListSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot) throws IOException {
        ...
        @Override
        public void postCloneSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot, final TableDescriptor hTableDescriptor) throws IOException {
        ...
        @Override
        public void preRestoreSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot, final TableDescriptor hTableDescriptor) throws IOException {
            preRestoreSnapshotCalled = true;
        }

        @Override
        public void postRestoreSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot, final TableDescriptor hTableDescriptor) throws IOException {
        ...
        @Override
        public void preDeleteSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot) throws IOException {
            preDeleteSnapshotCalled = true;
        }

        @Override
        public void postDeleteSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx, final SnapshotDescription snapshot) throws IOException {
        ...
        @Override
        public void preCreateTableAction(final ObserverContext<MasterCoprocessorEnvironment> env, final TableDescriptor desc, final RegionInfo[] regions) throws IOException {
        ...
        @Override
        public void preDeleteTableAction(final ObserverContext<MasterCoprocessorEnvironment> env, final TableName tableName) throws IOException {
        ...
        @Override
        public void preTruncateTableAction(final ObserverContext<MasterCoprocessorEnvironment> env, final TableName tableName) throws IOException {
            preTruncateTableActionCalled = true;
        }

        @Override
        public void postCompletedTruncateTableAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final TableName tableName) throws IOException {
        ...
        @Override
        public void preModifyTableAction(final ObserverContext<MasterCoprocessorEnvironment> env, final TableName tableName, final TableDescriptor htd) throws IOException {
            preModifyTableActionCalled = true;
        }

        @Override
        public void postCompletedModifyTableAction(final ObserverContext<MasterCoprocessorEnvironment> env, final TableName tableName, final TableDescriptor htd) throws IOException {
        ...
        @Override
        public void preEnableTableAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final TableName tableName) throws IOException {
            preEnableTableActionCalled = true;
        }

        @Override
        public void postCompletedEnableTableAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final TableName tableName) throws IOException {
        ...
        @Override
        public void preDisableTableAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final TableName tableName) throws IOException {
            preDisableTableActionCalled = true;
        }

        @Override
        public void postCompletedDisableTableAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final TableName tableName) throws IOException {
        ...
        @Override
        public void preMasterStoreFlush(ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException {
            preMasterStoreFlushCalled = true;
        }

        @Override
        public void postMasterStoreFlush(ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException {
        ...
        public boolean preAndPostForQueueLockAndHeartbeatLockCalled() {
            return preRequestLockCalled && postRequestLockCalled && preLockHeartbeatCalled && postLockHeartbeatCalled;
        }

        @Override
        public void preMergeRegionsCommitAction(final ObserverContext<MasterCoprocessorEnvironment> ctx, final RegionInfo[] regionsToMerge, final List<Mutation> metaEntries) throws IOException {
        }

        @Override
        public void preUpdateMasterConfiguration(ObserverContext<MasterCoprocessorEnvironment> ctx, Configuration preReloadConf) throws IOException {
            preUpdateMasterConfigurationCalled = true;
        }

        @Override
        public void postUpdateMasterConfiguration(ObserverContext<MasterCoprocessorEnvironment> ctx, Configuration postReloadConf) throws IOException {
    ...
    public void testStarted() throws Exception {
        ...
        RestartFramework.at("after_coprocessor_verification").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testTableOperations() throws Exception {
        ...
        try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
            ...
            RestartFramework.at("after_merge_regions").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            tableCreationLatch = new CountDownLatch(1);
            ...
            RestartFramework.at("after_disable_table").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // enable
            ...
            RestartFramework.at("after_enable_table").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            admin.disableTable(tableName);
            assertTrue(admin.isTableDisabled(tableName));
            // modify table
            ...
            RestartFramework.at("after_modify_table").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // truncate table
            admin.truncateTable(tableName, false);
            RestartFramework.at("after_truncate_table").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // delete table
            admin.disableTable(tableName);
            assertTrue(admin.isTableDisabled(tableName));
            ...
            RestartFramework.at("after_delete_table").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            assertTrue("Table pre create handler called.", cp.wasPreCreateTableActionCalled());
            assertTrue("Table create handler should be called.", cp.wasCreateTableActionCalled());
            RestartFramework.at("after_table_create_2").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // disable
            ...
            assertTrue("Coprocessor should have been called on table disable", cp.wasDisableTableCalled());
            assertTrue("Disable table handler should be called.", cp.wasDisableTableActionCalled());
            RestartFramework.at("after_disable_table_2").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // modify table
            htd.setMaxFileSize(512 * 1024 * 1024);
            modifyTableSync(admin, tableName, htd);
            assertTrue("Test table should have been modified", cp.wasModifyTableCalled());
            RestartFramework.at("after_modify_table_2").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // enable
            assertFalse(cp.wasEnableTableCalled());
            ...
            assertTrue("Coprocessor should have been called on table enable", cp.wasEnableTableCalled());
            assertTrue("Enable table handler should be called.", cp.wasEnableTableActionCalled());
            RestartFramework.at("after_enable_table_2").on(cluster).restart("regionserver").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // disable again
            admin.disableTable(tableName);
            assertTrue(admin.isTableDisabled(tableName));
            // delete table
            ...
            assertTrue("Coprocessor should have been called on table delete", cp.wasDeleteTableCalled());
            assertTrue("Delete table handler should be called.", cp.wasDeleteTableActionCalled());
            RestartFramework.at("after_delete_table_2").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }
    ...
    public void testSnapshotOperations() throws Exception {
        ...
        // create a table
        HTableDescriptor htd = new HTableDescriptor(tableName);
        RestartFramework.at("after_table_disable").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        htd.addFamily(new HColumnDescriptor(TEST_FAMILY));
        ...
        try {
            ...
            RestartFramework.at("after_snapshot").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Test list operation
            admin.listSnapshots();
            assertTrue("Coprocessor should have been called on snapshot list", cp.wasListSnapshotCalled());
            RestartFramework.at("after_list_snapshot").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_clone_snapshot").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_restore_snapshot").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_delete_snapshot").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            deleteTable(admin, tableName);
        }
    }
    ...
    public void testNamespaceOperations() throws Exception {
        MiniHBaseCluster cluster = UTIL.getHBaseCluster();
        RestartFramework.at("after_list_namespaces").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_get_namespace_descriptor").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertNotNull(admin.getNamespaceDescriptor(testNamespace));
        RestartFramework.at("after_create_namespace").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRegionTransitionOperations() throws Exception {
        ...
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
        RestartFramework.at("after_multi_region_table_create").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try (RegionLocator r = UTIL.getConnection().getRegionLocator(tableName)) {
            ...
            master.getMasterRpcServices().moveRegion(null, RequestConverter.buildMoveRegionRequest(firstGoodPair.getRegionInfo().getEncodedNameAsBytes(), ServerName.valueOf(destName)));
            assertTrue("Coprocessor should have been called on region move", cp.wasMoveCalled());
            RestartFramework.at("after_region_move").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // make sure balancer is on
            master.balanceSwitch(true);
            assertTrue("Coprocessor should have been called on balance switch", cp.wasBalanceSwitchCalled());
            RestartFramework.at("after_balance_switch").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // turn balancer off
            ...
            RestartFramework.at("after_balance").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            Admin admin = UTIL.getAdmin();
            admin.disableTable(tableName);
            deleteTable(admin, tableName);
    ...
    public void testTableDescriptorsEnumeration() throws Exception {
        ...
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
        RestartFramework.at("after_get_table_descriptors").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testTableNamesEnumeration() throws Exception {
        MiniHBaseCluster cluster = UTIL.getHBaseCluster();
        HMaster master = cluster.getMaster();
        RestartFramework.at("after_get_table_names").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        MasterCoprocessorHost host = master.getMasterCoprocessorHost();
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
    ...
    public void testAbortProcedureOperation() throws Exception {
        ...
        HMaster master = cluster.getMaster();
        MasterCoprocessorHost host = master.getMasterCoprocessorHost();
        RestartFramework.at("after_abort_procedure").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
    ...
    public void testGetProceduresOperation() throws Exception {
        MiniHBaseCluster cluster = UTIL.getHBaseCluster();
        HMaster master = cluster.getMaster();
        RestartFramework.at("after_get_procedures").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        MasterCoprocessorHost host = master.getMasterCoprocessorHost();
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
    ...
    public void testGetLocksOperation() throws Exception {
        ...
        HMaster master = cluster.getMaster();
        MasterCoprocessorHost host = master.getMasterCoprocessorHost();
        RestartFramework.at("after_get_locks").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        CPMasterObserver cp = host.findCoprocessor(CPMasterObserver.class);
        cp.resetStates();
        master.getLocks();
    ...
    public void testQueueLockAndLockHeartbeatOperations() throws Exception {
        ...
        RestartFramework.at("after_lock_heartbeat").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMasterStoreOperations() throws Exception {
        ...
        try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
            ...
            RestartFramework.at("after_master_store_flush").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }
    ...
    public void testUpdateConfiguration() throws Exception {
        ...
        try (Connection connection = ConnectionFactory.createConnection(UTIL.getConfiguration());
            ...
            RestartFramework.at("after_update_configuration").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }
}
