...
public class TestSafemodeBringsDownMaster_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSafemodeBringsDownMaster_RestartInjected.class);
  ...
  public void testSafemodeBringsDownMaster() throws Exception {
    ...
    RestartFramework.at("after_safemode_enter")
        .on(UTIL.getMiniHBaseCluster())
    ...
    if (index != -1) {
      ...
      RestartFramework.at("after_abort_regionserver")
          .on(UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
