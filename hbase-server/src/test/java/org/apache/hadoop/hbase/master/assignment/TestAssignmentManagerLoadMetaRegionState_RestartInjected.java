...
public class TestAssignmentManagerLoadMetaRegionState_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAssignmentManagerLoadMetaRegionState_RestartInjected.class);
  ...
  public void testRestart() throws InterruptedException, IOException {
    ...
    RestartFramework.at("after_get_initial_regions")
        .on(UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_get_new_regions")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
