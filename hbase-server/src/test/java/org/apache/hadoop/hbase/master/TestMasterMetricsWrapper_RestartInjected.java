...
public class TestMasterMetricsWrapper_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterMetricsWrapper_RestartInjected.class);
  ...
  public void testInfo() throws IOException {
    ...
    RestartFramework.at("after_metrics_wrapper_create")
    ...
    RestartFramework.at("after_metrics_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
    ...
    RestartFramework.at("after_master_notice_stopped_rs")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_decommission_regionserver")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testQuotaSnapshotConversion() {
    ...
    RestartFramework.at("after_quota_wrapper_create")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
