...
public class TestReplicationStatusSourceStartedTargetStoppedNewOp_RestartInjected extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationStatusSourceStartedTargetStoppedNewOp_RestartInjected.class);
  ...
  public void testReplicationStatusSourceStartedTargetStoppedNewOp() throws Exception {
    ...
    RestartFramework.at("after_source_cluster_restart")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_sleep_wait_lag")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_metrics")
        .on(UTIL1.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
