...
public class TestSpaceQuotaBasicFunctioning_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSpaceQuotaBasicFunctioning_RestartInjected.class);
  ...
  public void testNoInsertsWithPut() throws Exception {
    RestartFramework.at("before_test")
  ...
  public void testNoCompactions() throws Exception {
    ...
    RestartFramework.at("after_compaction_rejection_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
