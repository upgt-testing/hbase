...
public class TestFullLogReconstruction_RestartInjected {
  private static final Logger LOG = LoggerFactory.getLogger(TestFullLogReconstruction_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestFullLogReconstruction_RestartInjected.class);
  ...
  public void testReconstruction() throws Exception {
    ...
    RestartFramework.at("after_multiple_puts")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
