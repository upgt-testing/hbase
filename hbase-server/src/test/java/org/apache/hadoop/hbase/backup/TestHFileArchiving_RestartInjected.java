...
public class TestHFileArchiving_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestHFileArchiving_RestartInjected.class);
  ...
  public void testRemoveRegionDirOnArchive() throws Exception {
    ...
    RestartFramework.at("after_archive_region")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
