...
public class TestAsyncTableLocateRegionForDeletedTable_RestartInjected_Randomized_456 {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestAsyncTableLocateRegionForDeletedTable_RestartInjected.class);
    ...
    public void test() throws Exception {
        ...
        TEST_UTIL.waitFor(60000, () -> TEST_UTIL.getMiniHBaseCluster().getRegions(TABLE_NAME).size() == 2);
        RestartFramework.at("after_table_recreate").on(cluster).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
