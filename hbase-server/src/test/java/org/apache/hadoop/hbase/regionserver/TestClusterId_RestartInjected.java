...
public class TestClusterId_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClusterId_RestartInjected.class);
  ...
  public void testClusterId() throws Exception {
    ...
    StartMiniClusterOption option =
      StartMiniClusterOption.builder().numMasters(1).numRegionServers(0).build();
    TEST_UTIL.startMiniHBaseCluster(option);

    RestartFramework.at("after_hbase_cluster_start")
    ...
    RestartFramework.at("after_server_online")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRewritingClusterIdToPB() throws Exception {
    ...
    RestartFramework.at("before_server_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
