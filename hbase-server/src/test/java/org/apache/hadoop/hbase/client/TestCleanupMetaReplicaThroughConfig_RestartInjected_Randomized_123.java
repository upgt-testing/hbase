...
public class TestCleanupMetaReplicaThroughConfig_RestartInjected_Randomized_123 extends MetaWithReplicasTestBase {

    @ClassRule
    public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule.forClass(TestCleanupMetaReplicaThroughConfig_RestartInjected.class);
    ...
    public void testReplicaCleanup() throws Exception {
        ...
        RestartFramework.at("after_meta_replica_check").on(TEST_UTIL.getMiniHBaseCluster()).restart("master").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
