...
public class TestRegionPlansWithThrottle_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRegionPlansWithThrottle_RestartInjected.class);
  ...
  public void testExecuteRegionPlansWithThrottling() throws Exception {
    ...
    RestartFramework.at("after_create_region_plans")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_execute_region_plans")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
