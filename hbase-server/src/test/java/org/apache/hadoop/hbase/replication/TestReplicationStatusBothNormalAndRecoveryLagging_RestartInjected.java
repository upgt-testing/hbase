...
public class TestReplicationStatusBothNormalAndRecoveryLagging_RestartInjected extends TestReplicationBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReplicationStatusBothNormalAndRecoveryLagging_RestartInjected.class);
