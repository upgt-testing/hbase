...
public class TestBlockReorderMultiBlocks_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestBlockReorderMultiBlocks_RestartInjected.class);
  ...
  public void testHBaseCluster() throws Exception {
    ...
    HRegionServer targetRs =
      LoadBalancer.isTablesOnMaster(hbm.getConf()) ? hbm.getMaster() : hbm.getRegionServer(0);
