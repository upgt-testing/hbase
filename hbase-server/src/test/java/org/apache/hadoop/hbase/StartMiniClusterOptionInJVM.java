 ...
 *
 * <pre>
 *    StartMiniClusterOptionInJVM option = StartMiniClusterOptionInJVM.builder().
...
public final class StartMiniClusterOptionInJVM {
  /**
   ...
   */
  private StartMiniClusterOptionInJVM(int numMasters, int numAlwaysStandByMasters,
    Class<?> masterClass, int numRegionServers, List<Integer> rsPorts,
  ...
  public String toString() {
    return "StartMiniClusterOptionInJVM{" + "numMasters=" + numMasters + ", masterClass=" + masterClass
  ...
  /**
   * Builder pattern for creating an {@link StartMiniClusterOptionInJVM}. The default values of its
  ...
  public static final class Builder {
    ...
    public StartMiniClusterOptionInJVM build() {
      if (dataNodeHosts != null && dataNodeHosts.length != 0) {
        numDataNodes = dataNodeHosts.length;
      }
      return new StartMiniClusterOptionInJVM(numMasters, numAlwaysStandByMasters, masterClass,
    ...
    public Builder masterClass(Class<?> masterClass) {
      this.masterClass = masterClass;
      return this;
    }
