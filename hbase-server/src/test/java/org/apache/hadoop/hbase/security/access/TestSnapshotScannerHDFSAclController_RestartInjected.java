...
public class TestSnapshotScannerHDFSAclController_RestartInjected {
  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestSnapshotScannerHDFSAclController_RestartInjected.class);
  @Rule
  public TestName name = new TestName();
  private static final Logger LOG =
    LoggerFactory.getLogger(TestSnapshotScannerHDFSAclController_RestartInjected.class);
  ...
  public void testGrantGlobal1() throws Exception {
    ...
    RestartFramework.at("after_grant_global")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGrantGlobal2() throws Exception {
    ...
    RestartFramework.at("after_grant_namespace")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_snapshot2")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGrantGlobal3() throws Exception {
    ...
    RestartFramework.at("after_table1_create")
        ...
        .execute();
    snapshotAndWait(snapshot1, table1);
    RestartFramework.at("after_snapshot1")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_grant_table")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGrantMobTable() throws Exception {
    ...
    try (Table t = TestHDFSAclHelper.createMobTable(TEST_UTIL, table)) {
      TestHDFSAclHelper.put(t);
      RestartFramework.at("after_mob_table_create")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRevokeGlobal1() throws Exception {
    ...
    RestartFramework.at("after_revoke_global")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRevokeGlobal2() throws Exception {
    ...
    SecureTestUtil.grantOnNamespace(TEST_UTIL, grantUserName, namespace, READ);
    TestHDFSAclHelper.grantOnTable(TEST_UTIL, grantUserName, table1, READ);
    RestartFramework.at("after_grants")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTruncateTable() throws Exception {
    ...
    try (Table t = TestHDFSAclHelper.createTable(TEST_UTIL, tableName)) {
      ...
      RestartFramework.at("after_truncate")
          .on(TEST_UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testModifyTable2() throws Exception {
    ...
    RestartFramework.at("after_table2_grant")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
