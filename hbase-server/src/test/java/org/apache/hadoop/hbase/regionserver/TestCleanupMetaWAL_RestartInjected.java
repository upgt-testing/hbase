...
public class TestCleanupMetaWAL_RestartInjected {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestCleanupMetaWAL_RestartInjected.class);
  ...
  public void testCleanupMetaWAL() throws Exception {
    ...
    RestartFramework.at("after_scp_wait")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_wal_verification")
        .on(TEST_UTIL.getMiniHBaseCluster())
