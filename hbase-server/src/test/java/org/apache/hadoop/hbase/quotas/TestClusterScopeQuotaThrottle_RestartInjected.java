...
public class TestClusterScopeQuotaThrottle_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestClusterScopeQuotaThrottle_RestartInjected.class);
  ...
  public void testNamespaceClusterScopeQuota() throws Exception {
    ...
    RestartFramework.at("after_operations")
        .on(TEST_UTIL.getMiniHBaseCluster())
