...
public class TestShutdownBackupMaster_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestShutdownBackupMaster_RestartInjected.class);
  ...
  public void testShutdownWhileBecomingActive() throws InterruptedException {
    ...
    RestartFramework.at("after_find_masters")
        .on(cluster)
