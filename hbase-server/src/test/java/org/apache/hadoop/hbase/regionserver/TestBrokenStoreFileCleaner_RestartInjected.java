...
public class TestBrokenStoreFileCleaner_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestBrokenStoreFileCleaner_RestartInjected.class);
  ...
  public void setUp() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_rs")
      .on(testUtil.getMiniHBaseCluster())
