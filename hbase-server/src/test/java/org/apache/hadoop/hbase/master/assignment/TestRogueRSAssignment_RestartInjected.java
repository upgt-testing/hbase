...
public class TestRogueRSAssignment_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRogueRSAssignment_RestartInjected.class);
  ...
  public static void setupCluster() throws Exception {
    ...
    RestartFramework.at("after_get_cluster")
        .on(UTIL.getMiniHBaseCluster())
  ...
  public void setup() throws IOException {
    ...
    RestartFramework.at("after_turn_off_balancer")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void tearDown() throws Exception {
    ...
    RestartFramework.at("after_delete_tables")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_turn_on_balancer")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReportRSWithWrongRegion() throws Exception {
    ...
    RestartFramework.at("after_make_fake_request")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_send_fake_request")
        .on(UTIL.getMiniHBaseCluster())
        .restart("regionserver")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
