...
/**
 * ProcessBased version of {@link TestScannersFromClientSide}.
 *
 * Transformed from MiniHBaseCluster/HBaseTestingUtility to ProcessBasedMiniHBaseCluster to enable
 * process-based testing and multi-version upgrade scenarios.
 *
 * <p>Reduced version (94% logic preserved): 17 test methods transformed, all pure client-side
 * scanner tests. testScanOnReopenedRegion removed (requires HRegionServer.getOnlineRegion() to
 * verify region offline/online state - internal access). Each test method has 2 checkpoint
 * variants (NO_UPGRADE, AFTER_CLUSTER_START).
 *
 * @see TestScannersFromClientSide Original test using MiniHBaseCluster
 */
@Category({ MediumTests.class, ClientTests.class })
public class TestScannersFromClientSide_ProcessBased extends ProcessBasedUpgradeTestBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestScannersFromClientSide_ProcessBased.class);

  private static final Logger LOG =
    LoggerFactory.getLogger(TestScannersFromClientSide_ProcessBased.class);
  ...
  @Test
  public void testScanImmutable_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanImmutableImpl();
  }

  @Test
  public void testScanImmutable_AFTER_CLUSTER_START() throws Exception {
  ...
  private void testScanImmutableImpl() throws Exception {
    ...
    TableName tableName = TableName.valueOf("testScanImmutable");
    Table table = createTable(tableName, FAMILY);
    loadRandomRows(table, FAMILY, 100, 100);
  ...
  @Test
  public void testScanBatch_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanBatchImpl();
  }

  @Test
  public void testScanBatch_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScanBatchImpl();
  }
  ...
  private void testScanBatchImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testScanBatch");
    byte[][] QUALIFIERS = HTestConst.makeNAscii(QUALIFIER, 8);

    Table ht = createTable(tableName, FAMILY);
  ...
  @Test
  public void testMaxResultSizeIsSetToDefault_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testMaxResultSizeIsSetToDefaultImpl();
  }

  @Test
  public void testMaxResultSizeIsSetToDefault_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testMaxResultSizeIsSetToDefaultImpl();
  }
  ...
  private void testMaxResultSizeIsSetToDefaultImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testMaxResultSizeIsSetToDefault");
    Table ht = createTable(tableName, FAMILY);

    // The max result size we expect the scan to use by default.
    long expectedMaxResultSize = conf.getLong(HConstants.HBASE_CLIENT_SCANNER_MAX_RESULT_SIZE_KEY,
  ...
  @Test
  public void testScannerForNotExistingTable_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScannerForNotExistingTableImpl();
  }

  @Test
  public void testScannerForNotExistingTable_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScannerForNotExistingTableImpl();
  }
  ...
  @Test
  public void testSmallScan_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testSmallScanImpl();
  }

  @Test
  public void testSmallScan_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testSmallScanImpl();
  }
  ...
  private void testSmallScanImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testSmallScan");
  ...
  @Test
  public void testGetMaxResults_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testGetMaxResultsImpl();
  }

  @Test
  public void testGetMaxResults_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testGetMaxResultsImpl();
  }
  ...
  private void testGetMaxResultsImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testGetMaxResults");
    byte[][] FAMILIES = HTestConst.makeNAscii(FAMILY, 3);
    byte[][] QUALIFIERS = HTestConst.makeNAscii(QUALIFIER, 20);

    Table ht = createTable(tableName, FAMILIES);
  ...
  @Test
  public void testScanMaxResults_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanMaxResultsImpl();
  }

  @Test
  public void testScanMaxResults_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScanMaxResultsImpl();
  }
  ...
  private void testScanMaxResultsImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testScanMaxResults");
  ...
  @Test
  public void testGetRowOffset_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testGetRowOffsetImpl();
  }

  @Test
  public void testGetRowOffset_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testGetRowOffsetImpl();
  }
  ...
  private void testGetRowOffsetImpl() throws Exception {
    ...
    final TableName tableName = TableName.valueOf("testGetRowOffset");
    byte[][] FAMILIES = HTestConst.makeNAscii(FAMILY, 3);
    byte[][] QUALIFIERS = HTestConst.makeNAscii(QUALIFIER, 20);
  ...
  @Test
  public void testScanRawDeleteFamilyVersion_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanRawDeleteFamilyVersionImpl();
  }

  @Test
  public void testScanRawDeleteFamilyVersion_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScanRawDeleteFamilyVersionImpl();
  }
  ...
  private void testScanRawDeleteFamilyVersionImpl() throws Exception {
    ...
    testConf.set(RPC_CODEC_CONF_KEY, "");
    testConf.set(DEFAULT_CODEC_CLASS, "");
    try (Connection testConnection = ConnectionFactory.createConnection(testConf);
      Table table = testConnection.getTable(tableName)) {
  ...
  // TRANSFORMATION NOTE: testScanOnReopenedRegion removed.
  // Requires HRegionServer.getOnlineRegion() to verify region offline/online state during
  // unassign/assign operations (lines 721-744 in original). No client API exists to check
  // if a region is currently online/offline on a specific RegionServer.

  @Test
  public void testAsyncScannerWithSmallData_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testAsyncScannerWithSmallDataImpl();
  }

  @Test
  public void testAsyncScannerWithSmallData_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testAsyncScannerWithSmallDataImpl();
  }

  private void testAsyncScannerWithSmallDataImpl() throws Exception {
    testAsyncScanner(TableName.valueOf("testAsyncScannerWithSmallData"), 2, 3, 10, -1, null);
  }

  @Test
  public void testAsyncScannerWithManyRows_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testAsyncScannerWithManyRowsImpl();
  }

  @Test
  public void testAsyncScannerWithManyRows_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testAsyncScannerWithManyRowsImpl();
  }

  private void testAsyncScannerWithManyRowsImpl() throws Exception {
    testAsyncScanner(TableName.valueOf("testAsyncScannerWithManyRows"), 30000, 1, 1, -1, null);
  }

  @Test
  public void testAsyncScannerWithoutCaching_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testAsyncScannerWithoutCachingImpl();
  }

  @Test
  public void testAsyncScannerWithoutCaching_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testAsyncScannerWithoutCachingImpl();
  }

  private void testAsyncScannerWithoutCachingImpl() throws Exception {
    testAsyncScanner(TableName.valueOf("testAsyncScannerWithoutCaching"), 5, 1, 1, 1, (b) -> {
      try {
  ...
  private void testAsyncScanner(TableName table, int rowNumber, int familyNumber,
    ...
    Table ht = createTable(table, families);
  ...
  @Test
  public void testReadExpiredDataForRawScan_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testReadExpiredDataForRawScanImpl();
  }

  @Test
  public void testReadExpiredDataForRawScan_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testReadExpiredDataForRawScanImpl();
  }
  ...
  private void testReadExpiredDataForRawScanImpl() throws Exception {
    ...
    try (Table table = createTable(tableName, FAMILY)) {
      ...
      admin.modifyColumnFamily(tableName, new HColumnDescriptor(FAMILY).setTimeToLive(5));
  ...
  @Test
  public void testScanWithColumnsAndFilterAndVersion_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanWithColumnsAndFilterAndVersionImpl();
  }

  @Test
  public void testScanWithColumnsAndFilterAndVersion_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScanWithColumnsAndFilterAndVersionImpl();
  }
  ...
  private void testScanWithColumnsAndFilterAndVersionImpl() throws Exception {
    ...
    TableName tableName = TableName.valueOf("testScanWithColumnsAndFilterAndVersion");
    long now = EnvironmentEdgeManager.currentTime();
    try (Table table = createTable(tableName, FAMILY, 4)) {
      for (int i = 0; i < 4; i++) {
        Put put = new Put(ROW);
  ...
  @Test
  public void testScanWithSameStartRowStopRow_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScanWithSameStartRowStopRowImpl();
  }

  @Test
  public void testScanWithSameStartRowStopRow_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScanWithSameStartRowStopRowImpl();
  }
  ...
  @Test
  public void testReverseScanWithFlush_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testReverseScanWithFlushImpl();
  }

  @Test
  public void testReverseScanWithFlush_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testReverseScanWithFlushImpl();
  }
  ...
  private void testReverseScanWithFlushImpl() throws Exception {
    ...
    TableName tableName = TableName.valueOf("testReverseScanWithFlush");
  ...
  @Test
  public void testScannerWithPartialResults_NO_UPGRADE() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.NO_UPGRADE;
    testScannerWithPartialResultsImpl();
  }

  @Test
  public void testScannerWithPartialResults_AFTER_CLUSTER_START() throws Exception {
    upgradeCheckpoint = HBaseUpgradeCheckpoints.AFTER_CLUSTER_START;
    testScannerWithPartialResultsImpl();
  }
  ...
  private void testScannerWithPartialResultsImpl() throws Exception {
    ...
    try (Table table = createMultiRegionTable(tableName, Bytes.toBytes("c"), 4)) {
      List<Put> puts = new ArrayList<>();
  ...
  private Table createTable(TableName tableName, byte[] family, int maxVersions)
    throws IOException {
  ...
  private Table createTable(TableName tableName, byte[][] families) throws IOException {
    TableDescriptorBuilder builder = TableDescriptorBuilder.newBuilder(tableName);
  ...
  private Table createMultiRegionTable(TableName tableName, byte[] family, int regionCount)
    throws IOException {
    byte[][] splits = new byte[regionCount - 1][];
    for (int i = 0; i < regionCount - 1; i++) {
      splits[i] = Bytes.toBytes(String.format("split%02d", i));
    }
    TableDescriptorBuilder builder = TableDescriptorBuilder.newBuilder(tableName);
    builder.setColumnFamily(ColumnFamilyDescriptorBuilder.of(family));
  ...
  private void loadRandomRows(Table table, byte[] family, int rowCount, int colCount)
    throws IOException {
    List<Put> puts = new ArrayList<>();
    for (int i = 0; i < rowCount; i++) {
      ...
      for (int j = 0; j < colCount; j++) {
        put.addColumn(family, Bytes.toBytes("col" + j), Bytes.toBytes("value" + i + "_" + j));
      }
      puts.add(put);
    }
    table.put(puts);
