...
public class TestReopenTableRegionsProcedureBatchBackoff_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestReopenTableRegionsProcedureBatchBackoff_RestartInjected.class);
  ...
  public void testRegionBatchBackoff() throws IOException {
    ...
    RestartFramework.at("after_submit_backoff")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRegionBatchNoBackoff() throws IOException {
    ...
    RestartFramework.at("after_submit_nobackoff")
        .on(UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
