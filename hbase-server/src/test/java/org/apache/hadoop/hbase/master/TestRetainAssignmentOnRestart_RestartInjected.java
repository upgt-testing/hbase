...
public class TestRetainAssignmentOnRestart_RestartInjected extends AbstractTestRestartCluster {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestRetainAssignmentOnRestart_RestartInjected.class);
  ...
  public void testRetainAssignmentOnClusterRestart() throws Exception {
    setupCluster();
    RestartFramework.at("after_setup_cluster")
    ...
    snapshot.initialize();
    RestartFramework.at("after_snapshot_init")
        .on(cluster)
        .restart("regionserver")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
