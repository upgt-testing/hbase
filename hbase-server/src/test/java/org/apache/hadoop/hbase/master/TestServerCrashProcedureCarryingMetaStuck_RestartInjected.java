...
public class TestServerCrashProcedureCarryingMetaStuck_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestServerCrashProcedureCarryingMetaStuck_RestartInjected.class);
  ...
  public void test() throws Exception {
    ...
    RestartFramework.at("after_find_meta_server")
    ...
    try (AsyncConnection conn =
      ...
      RestartFramework.at("after_transit_procedure_created")
          .on(UTIL.getMiniHBaseCluster())
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
