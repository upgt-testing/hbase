...
public class TestScannerRPCScanMetrics_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestScannerRPCScanMetrics_RestartInjected.class);
  ...
  public void testScannerRPCScanMetrics() throws Exception {
    ...
    RestartFramework.at("after_scan1")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_scan3")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_metric_verification")
      .on(TEST_UTIL.getMiniHBaseCluster())
      .restart("regionserver")
      .withIndex(0)
      .withMode(RestartMode.GRACEFUL)
