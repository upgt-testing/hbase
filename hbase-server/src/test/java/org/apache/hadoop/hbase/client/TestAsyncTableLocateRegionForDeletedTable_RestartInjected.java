...
public class TestAsyncTableLocateRegionForDeletedTable_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableLocateRegionForDeletedTable_RestartInjected.class);
