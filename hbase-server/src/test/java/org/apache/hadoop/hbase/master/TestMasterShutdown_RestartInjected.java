...
public class TestMasterShutdown_RestartInjected {
  private static final Logger LOG = LoggerFactory.getLogger(TestMasterShutdown_RestartInjected.class);

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestMasterShutdown_RestartInjected.class);
  ...
  public void testMasterShutdown() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_wait_master_threads")
          .on(cluster)
      ...
      RestartFramework.at("after_find_active_master")
          .on(cluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_verify_backup_masters")
          .on(cluster)
          .restart("regionserver")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMasterShutdownBeforeStartingAnyRegionServer() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_create_local_cluster")
          .on(hbaseCluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_start_master_thread")
          .on(hbaseCluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_server_manager_available")
          .on(hbaseCluster)
          .restart("master")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
