...
public class TestChangingEncoding_RestartInjected {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestChangingEncoding_RestartInjected.class);
  ...
  public void testChangingEncoding() throws Exception {
    ...
    for (boolean onlineChange : new boolean[] { false, true }) {
      for (DataBlockEncoding encoding : ENCODINGS_TO_ITERATE) {
        ...
        if (iterationCount == 0) {
          RestartFramework.at("after_encoding_change")
              .on(TEST_UTIL.getMiniHBaseCluster())
