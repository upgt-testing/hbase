...
public class TestAsyncTableAdminApi_RestartInjected extends TestAsyncAdminBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAsyncTableAdminApi_RestartInjected.class);
  ...
  public void testCreateTableNumberOfRegions() throws Exception {
    ...
    RestartFramework.at("after_table5_create")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateTableWithRegions() throws Exception {
    ...
    RestartFramework.at("after_table2_create_with_regions")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_table3_create_with_regions")
        .on(TEST_UTIL.getMiniHBaseCluster())
        .restart("master")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
