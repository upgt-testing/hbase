...
public class NamedQueueGetResponse implements NamedQueueGetResponseJVMInterface {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("slowLogPayloads", slowLogPayloads)
      .append("balancerDecisions", balancerDecisions)
      .append("balancerRejections", balancerRejections).append("namedQueueEvent", namedQueueEvent)
      .toString();
  }
