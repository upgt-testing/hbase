 ...
 * {@link org.apache.hadoop.hbase.regionserver.HRegionServer} process via configuration parameter
 * 'hbase.procedure.regionserver.classes'. An example of globally barriered procedure implementation
 * is {@link org.apache.hadoop.hbase.master.snapshot.SnapshotManager} and
 * {@link org.apache.hadoop.hbase.regionserver.snapshot.RegionServerSnapshotManager}. A globally
 ...
 * {@link org.apache.hadoop.hbase.regionserver.HRegionServer} which create the procedure znode and
 * register the listeners. A procedure can be triggered by its signature and an instant name
 * (encapsulated in a {@link ProcedureDescription} object). When the servers are shutdown, the stop
